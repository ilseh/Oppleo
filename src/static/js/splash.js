/* TODO
- energy
  - geef SplashEnergyTableEntry een periode mee (startdatum t/m einddatum), energywaarden opgeteld.
    - In de Tabel een Kalender knopje om een dag, week, maand of jaar periode te kiezen voor de tabel
       - Een tabeloverzicht van het verbruik vandaag, deze maand, dit jaar
    - Maak een overzicht van het verbruik per maand
  - in grafiek totaalverbruik per maand (gridafname + verbruikte zonneenergy) + grootste verbruikers?
  - specifieke grafieken: 
    - koelkast on/off power + energy
    - meterkast power + energy
  - pie chart totaalverbruik verdeeld in grootste afnemers, per dag/week/maand periode (kalender) 
...
var devicelist_temp = [	[ 342, 'Deursensor', 'Aeotec'],
    					...
    					[ 711, 'Thermo/Hygro sensor', 'Everspring Multilevel Sensor' ], // Badkamer 2e
//    					[ 742, 'Thermo/Hygro sensor', 'Oregon THGN800' ],	// Oude tuin thermometer
    					[ 923, 'Raamsensor', 'Fibaro Window/Door' ],
    					[ 935, 'Deursensor', 'Fibaro Window/Door' ],
    					[ 943, 'Deursensor', 'Fibaro Window/Door' ],
    					[ 950, 'Deursensor', 'Sensative Sensor Strip' ],
                        [ 955, 'Deursensor', 'Sensative Sensor Strip' ], // Slaapkamer Deursensor 2e verdieping Batterij
    					[ 1105,'Thermo/Hygro sensor', 'TFA TS33C' ],	// Tuin
    					[ 1108,'Thermo/Hygro sensor', 'TFA TS33C' ]		// Buiten 2e verdieping
...
//  power
var hsDevices = [
				 [ 258, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra verbruik laag
				 [ 259, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra verbruik laag vandaag
				 [ 260, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra verbruik hoog
				 [ 261, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra verbruik hoog vandaag
				 [ 263, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra teruglevering laag vandaag
				 [ 264, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra teruglevering hoog
				 [ 265, 'Meterkast',	'SplashEnergyDevice',	null ], // P1 Meterkast Elektra teruglevering hoog vandaag
				 [ 267, 'Meterkast',	'SplashPowerDevice',	null ], // Meterkast Current total usage
 				 [ 269, 'Meterkast',	'',	                    null ], // Elektra huidig verbruik vandaag max
 				 [ 268, 'Meterkast',	'',	                    null ], // Elektra huidig verbruik vandaag min
                 [ 270, 'Meterkast',    'SplashGasDevice',  	null ], // Gas verbruik
                 [ 271, 'Meterkast',    'SplashGasDevice',  	null ], // Gas verbruik totaal
                 [ 272, 'Meterkast',    'SplashPowerDevice',    null ], // P1 Elektra huidige teruglevering
                 [ 273, 'Meterkast',    '',                     null ], // Elektra teruglevering vandaag min
                 [ 274, 'Meterkast',    '',                     null ], // P1 Elektra teruglevering vandaag max
                 ...
                 [ 376, 'Woonkamer',    'SplashLightDevice',    null ], // Stekkerdoos On/Off 1 Kleurenlamp ( 393, 378, 381, 384, 387, 390 )
                 [ 377, 'Woonkamer',    'SplashLightDevice',    null ], // Stekkerdoos On/Off 2 Marantz Receiver ( 393, 378, 381, 384, 387, 390 )
                 [ 378, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 2 Marantz Receiver ( 393, 378, 381, 384, 387, 390 )
                 [ 379, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 2 Marantz Receiver ( 394, 379, 382, 385, 388, 391 )
                 [ 380, 'Woonkamer',    'SplashLightDevice',    null ], // Stekkerdoos On/Off 3 Candlelight oplader ( 393, 378, 381, 384, 387, 390 )
                 [ 381, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 3 Candlelight oplader ( 393, 378, 381, 384, 387, 390 )
                 [ 382, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 3 Candlelight oplader ( 394, 379, 382, 385, 388, 391 )
                 [ 383, 'Woonkamer',    'SplashLightDevice',    null ], // Stekkerdoos On/Off 4 ( 393, 378, 381, 384, 387, 390 )
                 [ 384, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 4 ( 393, 378, 381, 384, 387, 390 )
                 [ 385, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 4 ( 394, 379, 382, 385, 388, 391 )
                 [ 386, 'Woonkamer',    'SplashLightDevice',    null ], // Stekkerdoos On/Off 5 Gramofon ( 393, 378, 381, 384, 387, 390 )
                 [ 387, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 5 Gramofon ( 393, 378, 381, 384, 387, 390 )
                 [ 388, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 5 Gramofon ( 394, 379, 382, 385, 388, 391 )
                 [ 389, 'Woonkamer',    'SplashLightDevice',    null ], // Stekkerdoos On/Off 6 Thermostaat ( 393, 378, 381, 384, 387, 390 )
                 [ 390, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 6 Thermostaat ( 393, 378, 381, 384, 387, 390 )
                 [ 391, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 6 Thermostaat ( 394, 379, 382, 385, 388, 391 )
                 [ 393, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 1 Kleurenlamp ( 393, 378, 381, 384, 387, 390 )
                 [ 394, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 1 Kleurenlamp ( 394, 379, 382, 385, 388, 391 )
                 ...
                 [ 448, 'Washok',       'SplashPowerDevice',    null ], // Washok Wasmachine Power
                 [ 451, 'Washok',       'SplashEnergyDevice',   null ], // Washok Droogtrommel kWh
                 [ 453, 'Washok',       'SplashPowerDevice',    null ], // Washok Droogtrommel Power
                 [ 467, 'Meterkast',    'SplashTempDevice', 	null ], // Meterkast temperatuur (rookmelder)
                 [ 505, 'Gang',         'SplashEnergyDevice',   null ], // Designlamp kWh
                 [ 506, 'Gang',         '',                     null ], // Designlamp Watt
                 [ 507, 'Gang',         'SplashPowerDevice',    null ], // Designlamp Power
                 [ 508, 'Gang',         'SplashLightDevice',    null ], // Designlamp
                 [ 515, '1e Overloop',  'SplashEnergyDevice',   null ], // 1e overloop plafondspots kWh
                 [ 516, '1e Overloop',  'SplashPowerDevice',    null ], // 1e overloop plafondspots Watt
                 ...
                 [ 595, 'Slaapkamer',   'SplashEnergyDevice',   null ], // Slaapkamer Wandlampen kW Hours
                 [ 596, 'Slaapkamer',   '',                     null ], // Slaapkamer Wandlampen Watt
                 [ 597, 'Slaapkamer',   'SplashPowerDevice',    null ], // Slaapkamer Wandlampen Power
    		  	 [ 598, 'Slaapkamer', 	'SplashLightDevice',	null ],	// Slaapkamer Wandlampen
                 [ 634, 'Meterkast',    'SplashEnergyDevice',   null ], // Verbruik netwerk totaal
                 [ 635, 'Meterkast',    'SplashEnergyDevice',   null ], // P1 Verbruik netwerk vandaag - teruglevering
                 [ 661, 'Inloopkast',   'SplashLightDevice',    null ], // Wandspots inloopkast
                 [ 669, 'Inloopkast',   'SplashEnergyDevice',   null ], // Wandspots kWh
                 [ 670, 'Inloopkast',   'SplashPowerDevice',    null ], // Wandspots Watt
                 ...
                 [ 695, 'Badkamer 2',   'SplashPowerDevice',    null ], // Badkamer Lampen Watt 
                 ...
                 [ 706, 'Badkamer 2',   'SplashPowerDevice',    null ], // Badkamer 2 FAN Watt
                 ...
                 [ 736, 'Woonkamer',    '',                     null ], // Washok Droogtrommel Watts
                 [ 737, 'Woonkamer',    'SplashPowerDevice',    null ], // Washok Droogtrommel Power
    		  	 [ 738, 'Woonkamer',	'SplashLightDevice',	null ],	// Woonkamer Vlechtlamp
                 [ 740, '',             '',                     null ], // previously this was the Tuintemperatuur
                 [ 741, '',             '',                     null ], // previously this was the Tuin luchtvochtigheid
                 [ 742, '',             '',                     null ], // previously this was the Tuintemperatuur
                 [ 743, '',             '',                     null ], // previously this was the Tuin luchtvochtigheid
...
//    		  	 [ 801, 'Woonkamer',	'SplashHarmonyDevice',	null ], // Harmony - TV (1: PowerOff, 2: PowerOn, 14: Mute, 15: VolumeDown, 16: VolumeUp, 41: AmbiLight, 42: AmbiMode)
                 ...
                 [ 821, 'Woonkamer',    'SplashPowerDevice',    null ], // Eettafel plafondlamp Watt             
                 [ 822, 'Woonkamer',    'SplashPowerDevice',    null ], // Eettafel plafondlamp Power             
                 [ 824, 'Tuin',         'SplashLightDevice',    null ], // Gevellamp tuin                
    		  	 [ 826, 'Tuin', 		'SplashLightDevice',	null ],	// Gevelelektra tuin    		  	 
                 [ 832, 'Tuin',         'SplashLightDevice',    null ], // Gevellamp tuin kWh               
                 [ 837, 'Tuin',         'SplashLightDevice',    null ], // Tuinkabel                 
                 [ 843, 'Tuin',         'SplashEnergyDevice',   null ], // Tuinkabel kWh                
                 [ 844, 'Tuin',         'SplashPowerDevice',    null ], // Tuinkabel Watt
                 ...
                 [ 851, 'Keuken',       '',                     null ], // Plugwise Circle Keuken bovenste oven - switch
                 [ 852, 'Keuken',       '',                     null ], // Plugwise Circle+ Keuken onderste oven - switch
                 [ 853, 'Tuin',         'SplashTempDevice',     null ], // Tuintemperatuur
                 [ 854, 'Tuin',         'SplashHumidDevice',    null ], // Tuin luchtvochtigheid
                 [ 855, 'Tuin',         'SplashBatteryDevice',  null ], // Temp/Humid sensor batterijstatus
                 [ 866, 'Keuken',       '',                     null ], // Koelkast Root  
                 [ 867, 'Keuken',       'SplashEnergyDevice',   null ], // Keuken Koelkast kW Hours    
                 [ 868, 'Keuken',       '',                     null ], // Watts
                 [ 869, 'Keuken',       'SplashPowerDevice',    null ], // Koelkast Power 
                 [ 870, 'Keuken',       '',                     null ], // Koelkast   
                 [ 871, 'Keuken',       '',                     null ], // Vaatwasser en Quooker Root  
                 [ 872, 'Keuken',       'SplashEnergyDevice',   null ], // Vaatwasser en Quooker kW Hours
                 [ 873, 'Keuken',       '',                     null ], // Vaatwasser en Quooker Watts  
                 [ 874, 'Keuken',       'SplashPowerDevice',    null ], // Vaatwasser en Quooker Power 
                 [ 875, 'Keuken',       '',                     null ], // Vaatwasser en Quooker Switch
                 [ 876, 'Koelkast',     '',                     null ], // Root
                 [ 877, 'Berging',      'SplashEnergyDevice',   null ], // Berging Koelkast kW Hours     
                 [ 878, 'Berging',      '',                     null ], // Koelkast Watts
                 [ 879, 'Berging',      '',                     null ], // Koelkast Notification      
                 [ 880, 'Berging',      '',                     null ], // Koelkast Alarm
                 [ 881, 'Berging',      'SplashPowerDevice',    null ], // Koelkast Power    
                 [ 882, 'Berging',      '',                     null ], // Koelkast  
                 [ 883, 'CV Ruimte',    '',                     null ], // Huisventilatie Root      
                 [ 884, 'CV Ruimte',    'SplashEnergyDevice',   null ], // Huisventilatie kW Hours 
                 [ 885, 'CV Ruimte',    '',                     null ], // Huisventilatie Watts   
                 [ 886, 'CV Ruimte',    '',                     null ], // Huisventilatie Notification       
                 [ 887, 'CV Ruimte',    '',                     null ], // Huisventilatie Alarm
                 [ 888, 'CV Ruimte',    'SplashPowerDevice',    null ], // Huisventilatie Power    
                 [ 889, 'CV Ruimte',    '',                     null ], // Huisventilatie  
                 [ 890, 'CV Ruimte',    '',                     null ], // CV ketel Root  
                 [ 891, 'CV Ruimte',    'SplashEnergyDevice',   null ], // CV ketel kW Hours      
                 [ 892, 'CV Ruimte',    '',                     null ], // CV ketel Watts     
                 [ 893, 'CV Ruimte',    'SplashPowerDevice',    null ], // CV ketel Power   
                 [ 894, 'CV Ruimte',    '',                     null ], // CV ketel  
                 [ 895, 'Meterkast',    '',                     null ], // Plugwise Stealth Meterkast - switch
                 [ 897, 'Meterkast',    'SplashEnergyDevice',   null ], // Plugwise Stealth Meterkast - Energy
                 [ 898, 'Meterkast',    'SplashPowerDevice',    null ], // Plugwise Stealth Meterkast - Power
                 [ 899, 'Keuken',       'SplashPowerDevice',    null ], // Plugwise Circle+ Keuken onderste oven Power
                 [ 901, 'Keuken',       'SplashEnergyDevice',   null ], // Plugwise Circle+ Keuken onderste oven Energy contineous counter
                 [ 902, 'Keuken',       'SplashPowerDevice',    null ], // Plugwise Circle Keuken bovenste oven Power
                 [ 903, 'Keuken',       'SplashEnergyDevice',   null ], // Plugwise Circle+ Keuken bovenste oven Energy contineous counter
                 [ 905, 'Woonkamer',    'SplashEnergyDevice',   null ], // Luchtreiniger kWh
                 [ 909, 'Woonkamer',    'SplashPowerDevice',    null ], // Luchtreiniger W
                 [ 910, 'Woonkamer',    'SplashLightDevice',    null ], // Luchtreiniger aan/uit
                 [ 911, 'Woonkamer',    'SplashEnergyDevice',   null ], // P1 Elektra grid afname vandaag totaal (vervangt 635, dat is totaal grid afname - teruglevering)

                 [ 923, '1e Overloop',  'SplashBatteryDevice',  null ], // Batterij Raamsensor Overloop 1e verdieping
                 [ 925, '1e Overloop',  'SplashDoorWindowDevice',    null ], // Raam Overloop 1e verdieping open/dicht
                 [ 928, '1e Overloop',  'SplashTempDevice',     null ], // Temperatuur Raamsensor Overloop 1e verdieping

//                 [ 935, 'Gang', 		'SplashBatteryDevice',  null ], // Voordeur sensor Batterij
//                 [ 937, 'Gang', 		'SplashDoorWindowDevice',    null ], // Voordeur open/dicht
//                 [ 940, 'Gang', 		'SplashTempDevice',     null ], // Voordeur sensor Temperatuur

                 [ 943, 'Woonkamer',    'SplashBatteryDevice',  null ], // Batterij Tuindeursensor Woonkamer
                 [ 945, 'Woonkamer',    'SplashDoorWindowDevice',    null ], // Tuindeur Woonkamer open/dicht
                 [ 948, 'Woonkamer',    'SplashTempDevice',     null ], // Temperatuur Tuindeursensor Woonkamer

                 [ 950, 'Balzaal',      'SplashBatteryDevice',  null ], // Batterij Deursensor Balzaal 1e verdieping
                 [ 951, 'Balzaal',      'SplashDoorWindowDevice',    null ], // Deursensor Balzaal 1e verdieping

                 [ 955, 'Slaapkamer',   'SplashBatteryDevice',  null ], // Slaapkamer Deursensor 2e verdieping Batterij
                 [ 956, 'Slaapkamer',   'SplashDoorWindowDevice',    null ], // Slaapkamer Deursensor 2e verdieping Open/Dicht

                 [ 961, 'Balzaal',      'SplashEnergyDevice',   null ], // Deursensor Balzaal 1e verdieping
                 [ 964, 'Balzaal',      'SplashPowerDevice',    null ], // Deursensor Balzaal 1e verdieping
                 [ 965, 'Balzaal',      'SplashDoorWindowDevice',	 null ], // Deursensor Balzaal 1e verdieping

                 [ 980, 'Gardarobe',    'SplashTempDevice',     null ], // Deursensor Gardarobe kelder temperatuur
                 [ 977, 'Gardarobe',    'SplashDoorWindowDevice',    null ], // Deursensor Gardarobe kelder open/dicht
                 [ 975, 'Gardarobe',    'SplashBatteryDevice',  null ], // Deursensor Gardarobe kelder batterij

                 [ 983, 'Logeerkamer',  'SplashBatteryDevice', null ], // Raamsensor Logeerkamer batterij
                 [ 985, 'Logeerkamer',  'SplashDoorWindowDevice',   null ], // Raamsensor Logeerkamer open/dicht
                 [ 988, 'Logeerkamer',  'SplashTempDevice',    null ], // Raamsensor Logeerkamer temperatuur

                 [ 993, 'Logeerkamer',  'SplashBatteryDevice', null ], // Raamsensor Balzaal Raam links (zuid) batterij
                 [ 995, 'Logeerkamer',  'SplashDoorWindowDevice',   null ], // Raamsensor Balzaal Raam links (zuid) open/dicht
                 [ 998, 'Logeerkamer',  'SplashTempDevice',    null ], // Raamsensor Balzaal Raam links (zuid) temperatuur

                 [ 1001, 'Logeerkamer',  'SplashBatteryDevice', null ], // Raamsensor Balzaal Raam rechts (noord) batterij
                 [ 1003, 'Logeerkamer',  'SplashDoorWindowDevice',   null ], // Raamsensor Balzaal Raam rechts (noord) open/dicht
                 [ 1006, 'Logeerkamer',  'SplashTempDevice',    null ], // Raamsensor Balzaal Raam rechts (noord) temperatuur

                 [ 1019, 'Gang', 		'SplashBatteryDevice',  null ], // Voordeur sensor Batterij
                 [ 1021, 'Gang', 		'SplashDoorWindowDevice',    null ], // Voordeur open/dicht
                 [ 1024, 'Gang', 		'SplashTempDevice',     null ], // Voordeur sensor Temperatuur

    		  	 [ 1028, 'Woonkamer',	'SplashHarmonyDevice',	null ], // (797) Harmony - Activity (1: PowerOff, 2: TV kijken, 3: Radio, 4: Flubbertje muziek, 5: Flubbertje, 6: iTV met Marantz, 7: Gramofon)
    		  	 [ 1027, 'Woonkamer',	'SplashHarmonyDevice',	null ], // (798) Harmony - TV ontvanger (1: PowerToggle, 2: 0, 3: 1, 4: 2, 5: 3, 6: 4, 7: 5, 8: 6, 9: 7, 10: 8, 11: 9, 12: Mute, 13: Channel Down, 14: ChannelUp, 15: DirectionDown, 16: DirectionLeft, 17: DirectionRight, 18: DirectionUp, 19: Select, 20: Stop, 21: Rewind, 22: Pause, 23: FastForward, 24: Record, 25: SlowForward, 26: Menu, 27: Teletext, 28: Green, 29: Red, 30: Blue, 31: Yellow, 32: Guide, 33: Info, 34: Cancel, 36: Radio, 39: TV)
    		  	 [ 1029, 'Woonkamer',	'SplashHarmonyDevice',	null ], // (799) Harmony - Receiver (1: PowerOff, 2: PowerOn, 16: Mute, 17: VolumeDown, 18: VolumeUp)
    		  	 [ 1030, 'Woonkamer',	'SplashHarmonyDevice',	null ], // (801) Harmony - OLED TV (1: PowerOff, 2: PowerOn, 14: Mute, 15: VolumeDown, 16: VolumeUp, 41: AmbiLight, 42: AmbiMode)

    		  	 [ 1032, 'Woonkamer',	'SplashHarmonyDevice',	null ], // MeiHarmonyHub Root
    		  	 [ 1033, 'Woonkamer',	'SplashHarmonyDevice',	null ], // MeiHarmonyHub Gashouder 13 Hub
    		  	 [ 1034, 'Woonkamer',	'SplashHarmonyDevice',	null ], // MeiHarmonyHub Activities -	
    		  															//  Gramofon         11358301, (7)
    		  															//  TV Kijken        10894043, (2)
    		  															//  Smart-TV         34821455, (-)
    		  															//  Netflix          34640434, (-)
    		  															//  iTV met Marantz  10894051, (6)
    		  															//  PowerOff               -1, (1)
    		  															//  Smart-TV Marantz 34821369, (-)
    		  															//  Radio            10894044, (3)
    		  															//  Netflix Marantz  34801846  (-)
       		  	 [ 1035, 'Woonkamer',	'SplashHarmonyDevice',	null ], // MeiHarmonyHub - TV ontvanger (1: PowerToggle, 2: 0, 3: 1, 4: 2, 5: 3, 6: 4, 7: 5, 8: 6, 9: 7, 10: 8, 11: 9, 12: Mute, 13: Channel Down, 14: ChannelUp, 15: DirectionDown, 16: DirectionLeft, 17: DirectionRight, 18: DirectionUp, 19: Select, 20: Stop, 21: Rewind, 22: Pause, 23: FastForward, 24: Record, 25: SlowForward, 26: Menu, 27: Teletext, 28: Green, 29: Red, 30: Blue, 31: Yellow, 32: Guide, 33: Info, 34: Cancel, 36: Radio, 39: TV)
    		  	 [ 1036, 'Woonkamer',	'SplashHarmonyDevice',	null ], // MeiHarmonyHub - Receiver (1: PowerOff, 2: PowerOn, 16: Mute, 17: VolumeDown, 18: VolumeUp)
    		  	 [ 1037, 'Woonkamer',	'SplashHarmonyDevice',	null ], // MeiHarmonyHub - OLED TV (1: PowerToggle, 12: Mute, 13: VolumeDown, 14: VolumeUp, 45: AmbiLight)

    		  	 [ 1105, 'Tuin',		'SplashTempDevice',	null ], 	// TFA sensor
    		  	 [ 1106, 'Tuin',		'SplashHumidDevice',	null ], // TFA sensor
    		  	 [ 1107, 'Tuin',		'SplashBatteryDevice',	null ], // TFA sensor

    		  	 [ 1108, 'Buiten',		'SplashTempDevice',	null ], 	// TFA sensor
    		  	 [ 1109, 'Buiten',		'SplashHumidDevice',	null ], // TFA sensor
    		  	 [ 1110, 'Buiten',		'SplashBatteryDevice',	null ], // TFA sensor

				 [ 99999, 'CV Ruimte',  '',                     null ]  // Zonnepanelen (Power in Events en Energie in Energy)
   			];
...
function Settings() {
	...
	if ( !$('div#settings-modal').length ) {
		...
		var suh = [ BoseUpdateHandler, EHUpdateHandler, NRUpdateHandler, AudiUpdateHandler, HSUpdateHandler, Life360UpdateHandler, HSGraphDbDataUpdateHandler ];
...
var CentralSplashUpdater = {
    ...
    register: function( uid, handler, callback ) {
		var csu = this.csu;
		console.log( timestamp() + " CentralSplashUpdater.register() - registering " + handler.handlerName + " [uidt=" + handler.uidt + "] callback for " + uid );
...
// Retrieves the current = most recent - value from the Event database
var DBEventsValueUpdateHandler = {
	handlerName: 'CentralDBEventsValueUpdater',
	uidt: 'dbEvents',
    interval: 5000,	// Use 1 minute
    minInterval: 5000,	// Do not accept less than 10 seconds
    getUrl: function ( uid ) {
		return "assets/php/database.getstatus.php?ref=" + uid + "&table=Events";
	},
	parseData: function ( uid, data ) {
		console.log( timestamp() + " DBEventsValueUpdateHandler.parseData() - for ref " + uid );
		...
		// Now notify the callbacks
		CentralSplashUpdater.notify( DBEventsValueUpdateHandler.uidt, hsDev );
	}
};

// Retrieves the current = most recent - value from the Energy database
var DBEnergyValueUpdateHandler = {
	handlerName: 'CentralDBEnergyValueUpdater',
	uidt: 'dbEnergy',
    interval: 5000,	// Use 1 minute
    minInterval: 5000,	// Do not accept less than 10 seconds
    getUrl: function ( uid ) {
		return "assets/php/database.getstatus.php?ref=" + uid + "&table=Energy";
	},
	parseData: function ( uid, data ) {
		console.log( timestamp() + " DBEnergyValueUpdateHandler.parseData() - for ref " + uid );
		...
		// Now notify the callbacks
		CentralSplashUpdater.notify( DBEnergyValueUpdateHandler.uidt, hsDev );
	}
};

var HSGraphEventDataUpdateHandler = {
    handlerName: 'CentralHSGraphEventDataUpdater',
    uidt: 'flotPower',
    interval: 300000, // Use 5 minute
    minInterval: 60000,  // Do not accept less than 1 mniute
    getUrl: function ( uid ) {
//        return "assets/php/flot/events.php?id=" + uid + "&start=" + Math.floor(( new Date().getTime() - 12096e5 ) / 1000);            // Start is two weeks ago, No end, will use now
        return "assets/php/flot/lastweek.php?id=" + uid;
    },
    parseData: function ( uid, data ) {
        console.log( timestamp() + " HSGraphEventDataUpdateHandler.parseData() - for ref " + uid );

        var graphData = HSGraphEventDataDeviceFactory.create( data.id );
        graphData.setType( data.type );
        graphData.setData( data.data );
        graphData.setMin( data.min );
        graphData.setTsMin( data.tsMin );
        graphData.setTsMinTxt( data.tsMinTxt );
        graphData.setMax( data.max );
        graphData.setTsMax( data.tsMax );
        graphData.setTsMaxTxt( data.tsMaxTxt );

        // Now notify the callbacks
        CentralSplashUpdater.notify( HSGraphEventDataUpdateHandler.uidt, graphData );
    }
};


function HSGraphDbDataUpdateHandler( uniqueId = null ) {
    this.handlerName = 'CentralHSGraphDatabaseDataUpdater';
    this.uniqueId = uniqueId;
    this.uidt = 'flotDbEnergy' + ( uniqueId != null ? "_" + uniqueId : "" );
    this.interval = 300000; // Use 5 minute
    this.minInterval = 60000;  // Do not accept less than 1 mniute
    this.source = 'Energy';
    this.start = Math.floor(( new Date().getTime() - 12096e5 ) / 1000); // Start is default two weeks ago
    this.end = null;    // End is default Now (= null)
    this.startStr = formatDate( new Date(Date.now() + 12096e5), 'yyyy-MM-dd' ); // Start is default two weeks ago
    this.endStr = null;    // End is default Now (= null)
}
HSGraphDbDataUpdateHandler.prototype.getUrl = function ( uid ) {
//    return "assets/php/flot/daily.energy.php?id=" + uid + "&start=" + Math.floor(( new Date().getTime() - 12096e5 ) / 1000);            // Start is two weeks ago, No end, will use now
    return "assets/php/flot/daily.energy.php" +
    	"?id=" + uid +
        ( this.start != null ? "&start=" + this.start : ( this.startStr != null ? "&startStr=" + this.startStr : "" ) ) +
		"&table=" + this.source +
        ( this.end != null ? "&end=" + this.end : ( this.endStr != null ? "&endStr=" + this.endStr : "" ) ) +
        ( this.uniqueId != null ? "&uniqueId=" + this.uniqueId : "" );
}
HSGraphDbDataUpdateHandler.prototype.parseData = function ( uid, data ) {
    console.log( timestamp() + " HSGraphDbDataUpdateHandler.parseData() - for ref " + uid );

    var graphData = HSGraphEventDataDeviceFactory.create( data.id, data.uniqueId );
    graphData.setType( data.type );
    graphData.setData( ( data.data != null ? data.data : [] ) ); // If no datapoints are found, this element is missing (not an empty array!)
    graphData.setMin( data.min );
    graphData.setTsMin( data.from );
    graphData.setTsMinTxt( ( data.fromStr != null ? data.fromStr : "" ) );
    graphData.setMax( data.max );
    graphData.setTsMax( data.to );
    graphData.setTsMaxTxt( ( data.toStr != null ? data.toStr : "" ) );

    // Now notify the callbacks
    CentralSplashUpdater.notify( this.uidt, graphData );
}
HSGraphDbDataUpdateHandler.prototype.setSourceToEnergy = function () {
	this.source = 'Energy';
    this.uidt = 'flotDbEnergy' + ( this.uniqueId != null ? "_" + this.uniqueId : "" );
}
HSGraphDbDataUpdateHandler.prototype.setSourceToEvents = function () {
	this.source = 'Events';
    this.uidt = 'flotDbEvents' + ( this.uniqueId != null ? "_" + this.uniqueId : "" );
}


var HSGraphEnergyDataUpdateHandler_BACKUP = {
    handlerName: 'CentralHSGraphEnergyDataUpdater',
    uidt: 'flotEnergy',
    interval: 300000, // Use 5 minute
    minInterval: 60000,  // Do not accept less than 1 mniute
    getUrl: function ( uid ) {
    	// start date 2 weeks prior
        return "assets/php/flot/daily.energy.php?id=" + uid + "&start=" + Math.floor(( new Date().getTime() - 12096e5 ) / 1000);            // Start is two weeks ago, No end, will use now
    },
    parseData: function ( uid, data ) {
        console.log( timestamp() + " HSGraphEnergyDataUpdateHandler.parseData() - for ref " + uid );
        ...
        graphData.setMin( data.min );
        graphData.setTsMin( data.from );
        graphData.setTsMinTxt( data.fromStr );
        graphData.setMax( data.max );
        graphData.setTsMax( data.to );
        graphData.setTsMaxTxt( data.toStr );

        // Now notify the callbacks
        CentralSplashUpdater.notify( HSGraphEnergyDataUpdateHandler.uidt, graphData );
    }
};
...
function HSDevice ( ref ) {
    ...
    this.typeStr = "";
    this.handler = HSUpdateHandler;	// Default HomeSeer handler
}
...
HSDevice.prototype.setHandler = function( handler ) {
...
function HSGraphEventDataDevice ( ref, uniqueId = null ) {
    this.ref = ref;
    this.uniqueId = uniqueId;
    this.type = null;
    this.data = null;
...
HSGraphEventDataDevice.prototype.getUid = function() {
    return this.ref;
};
HSGraphEventDataDevice.prototype.getValue = function() {
    return 0;
};
HSGraphEventDataDevice.prototype.getHandler = function() {
    return HSGraphEventDataUpdateHandler;
};
HSGraphEventDataDevice.prototype.getUnit = function() {
    if ( typeof this.type != 'string' ) { return ''; }
    return this.type;
};
HSGraphEventDataDevice.prototype.getEnergyUnit = function() {
    if ( typeof this.type != 'string' ) { return ''; }
    return this.type;
};
HSGraphEventDataDevice.prototype.getEnergy = function() {
    return 0;
};
HSGraphEventDataDevice.prototype.setType = function( type ) {
    this.type = type;
};
HSGraphEventDataDevice.prototype.getType = function() {
    return this.type;
};
HSGraphEventDataDevice.prototype.setData = function( data ) {
    this.data = data;
};
HSGraphEventDataDevice.prototype.getData = function() {
    return this.data;
};
HSGraphEventDataDevice.prototype.getUniqueId = function() {
    return this.uniqueId;
};
HSGraphEventDataDevice.prototype.setMin = function( min ) {
    this.min = min;
};
HSGraphEventDataDevice.prototype.getMin = function() {
    return this.min;
};
HSGraphEventDataDevice.prototype.setTsMin = function( tsMin ) {
    this.tsMin = tsMin;
};
HSGraphEventDataDevice.prototype.getTsMin = function() {
    return this.tsMin;
};
HSGraphEventDataDevice.prototype.setTsMinTxt = function( tsMinTxt ) {
    this.tsMinTxt = tsMinTxt;
};
HSGraphEventDataDevice.prototype.getTsMinTxt = function() {
    return this.tsMinTxt;
};
HSGraphEventDataDevice.prototype.setMax = function( max ) {
    this.max = max;
};
HSGraphEventDataDevice.prototype.getMax = function() {
    return this.max;
};
HSGraphEventDataDevice.prototype.setTsMax = function( tsMax ) {
    this.tsMax = tsMax;
};
HSGraphEventDataDevice.prototype.getTsMax = function() {
    return this.tsMax;
};
HSGraphEventDataDevice.prototype.setTsMaxTxt = function( tsMaxTxt ) {
    this.tsMaxTxt = tsMaxTxt;
};
HSGraphEventDataDevice.prototype.getTsMaxTxt = function() {
    return this.tsMaxTxt;
};
...
var HSGraphEventDataDeviceFactory = {
    refs: [],
    create: function( ref, uniqueId = null ) { 
        var refId = ( uniqueId != null ? ref + "_" + uniqueId : ref );
        if ( !( refId in this.refs ) ) {
            // Create new
            this.refs[ refId ] = new HSGraphEventDataDevice( ref, uniqueId );
        }
        // Return newly created or existing one
...
var GrossNetEnergyCombiDevice = (function () {
    ...
    var homeSeerNetReturnEnergy = null;     // HomeSeer calculated Elektra teruglevering vandaag totaal
    ...
    function init() {
        ...
        homeSeerNetReturnEnergy = HSDeviceFactory.create( 849 );    // HomeSeer calculated Elektra teruglevering vandaag totaal
        ...
        return {
            ...
            getEnergy: function( ) {
                ...
                var netReturnEnergy = ( homeSeerNetReturnEnergy && typeof homeSeerNetReturnEnergy.getValue === 'function' && jQuery.isNumeric( homeSeerNetReturnEnergy.getValue() ) ? parseFloat( homeSeerNetReturnEnergy.getValue() ) : 0 );
                var netReturnEnergyUnit = ( homeSeerNetReturnEnergy && typeof homeSeerNetReturnEnergy.getUnit === 'function' ? homeSeerNetReturnEnergy.getUnit() : '' );
                ...
                // Calculate - minus returned energy
                switch( netReturnEnergyUnit ) {
                    case 'Wh':
                        value -= ( netReturnEnergy * 1000 ); 
                        break;
                    case 'kWh':
                        value -= ( netReturnEnergy * 1000 ); 
                        break;
                    default:
                        value -= netReturnEnergy; 
                }
                value = value / 1000;
            ...
            getHomeSeerNetReturnEnergy: function( ) {
                return homeSeerNetReturnEnergy;
            },
    ...
    return {
        ...
        getInstance: function () {
            if ( !instance ) {
                ...
                CentralSplashUpdater.register( instance.getHomeSeerNetReturnEnergy().getUid(), instance.getHomeSeerNetReturnEnergy().getHandler(), function() { instance.notify() } );
            }
            return instance;
        },
...
SplashCirclifulEnergyDevice.prototype.draw = function( ) {
    ...
    if ( $('#sced_' + uid).length ) {
        ...
        if ( sourceEnergy != null ) {
            $('#sced_'+uid+'_energy').html((((Math.round( sourceEnergy.getEnergy() *1000) /1000).toFixed(3))*1).toString()+sourceEnergy.getEnergyUnit());
            // Update the tooltip
            $('#sced_'+uid+'_energy').attr('data-original-title', '€ ' + (Math.round( (pricePer_kWh * sourceEnergy.getEnergy()) *100) /100).toFixed(2));
        }
...
// ----------------------- Homeseer Power Device Object ------------------------------------------

function SplashPowerTableEntry( powerRef ) {
    // Element tot attach it to
    this.power = HSDeviceFactory.create( powerRef );
    this.bindingElement = null;
    // Default width class. Works with col-lg-4, col-lg-6 and col-12
    this.widthClass = 'col-lg-3';   // col-lg-3 col-md-6
}
SplashPowerTableEntry.prototype.setBindingElement = function( bindingElement ) {
    this.bindingElement = bindingElement;
}
SplashPowerTableEntry.prototype.getBindingElement = function( ) {
    return this.bindingElement;
}
SplashPowerTableEntry.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashPowerTableEntry.prototype.getWidthClass = function( ) {
    return this.widthClass;
}
SplashPowerTableEntry.prototype.getPower = function( ) {
    return this.power;
};


SplashPowerTableEntry.prototype.draw = function( ) {
    console.log( timestamp() + " SplashPowerTableEntry.draw()");
    var obj = this;
    var power = this.getPower();
    var ref = power.getRef();
    
    // Does the element exist? No: draw, Yes: update
    if ( $('#spte_' + ref).length ) {
        console.log( timestamp() + " SplashPowerTableEntry.draw() - Update the element");

        $('#spte_' + ref + ' .energy_col_1').html( $('#spte_' + ref).index() +1 ); // row number
        $('#spte_' + ref + ' .energy_col_2').html( power.getLocation2() );    // Locatie
        $('#spte_' + ref + ' .energy_col_3').html( power.getLocation() );     // Locatie
        $('#spte_' + ref + ' .energy_col_4').html( power.getName() );         // Device
//        $('#spte_' + ref + ' .energy_col_4').attr( 'data-original-title', 'ref: '+power.getRef() );

        $('#spte_' + ref + ' .energy_col_5').html( Math.round( power.getValue() * 1000 ) /1000 );       // Waarde

        if ( typeof power.getStatus() == "string" ) {
            if ( power.getStatus().includes("kW" ) ) {
                $('#spte_' + ref + ' .energy_col_6').html( "kW" );       // Eenheid
            } else  if ( power.getStatus().includes("Watts") || power.getStatus().includes("W") ) {
                $('#spte_' + ref + ' .energy_col_6').html( "W" );       // Eenheid
            } else {
                $('#spte_' + ref + ' .energy_col_6').html( "W" );       // Eenheid            
            }
        } else {
        ...
        // Element dows not exist, draw it
        console.log( timestamp() + " SplashPowerTableEntry.draw() - Drawing new element");

        var elStr = `<tr id="spte_TOKEN_ID" class="settings_row">
                <td class="energy_col_1" scope="row">..</td>
                <td class="energy_col_2">..</td>
                <td class="energy_col_3 text-center">..</td>
                <td class="energy_col_4 text-left" id="spte_TOKEN_ID_ref" data-toggle="tooltip" data-placement="bottom" title="ref: TOKEN_ID">..</td>
                <td class="energy_col_5 text-right">..</td>
                <td class="energy_col_6 text-left"></td>
                <td class="energy_col_7"><i class="mdi mdi-battery-charging-40"> </i></td>
            </tr>`;

        elStr = elStr.replace( /TOKEN_ID/g, ref );
                
        $( obj.getBindingElement() + ' tbody' ).append( elStr );
        $('#spte_'+ref+'_ref').tooltip(); 

        // HSUpdateHandler gets the value straigt from HomeSeer, DBEventsValueUpdateHandler gets the most recent value
        // from the Events database table, and DBEnergyValueUpdateHandler from the Energy table.
        CentralSplashUpdater.register( power.getRef(), DBEventsValueUpdateHandler, function() { obj.draw() } );
    }
}

// ----------------------- Homeseer Energy Device Object ------------------------------------------
// Normalizes on kWh or Watts (so kW -> Watt and Wh to kWh)
function SplashEnergyTableEntry( energyRef ) {
    // Element tot attach it to
    this.energy = HSDeviceFactory.create( energyRef );
    this.bindingElement = null;
    // Default width class. Works with col-lg-4, col-lg-6 and col-12
    this.widthClass = 'col-lg-3';   // col-lg-3 col-md-6
    this.dataTables = null;
}
SplashEnergyTableEntry.prototype.setBindingElement = function( bindingElement ) {
    this.bindingElement = bindingElement;
}
SplashEnergyTableEntry.prototype.getBindingElement = function( ) {
    return this.bindingElement;
}
SplashEnergyTableEntry.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashEnergyTableEntry.prototype.getWidthClass = function( ) {
    return this.widthClass;
}
SplashEnergyTableEntry.prototype.getEnergy = function( ) {
    return this.energy;
};
SplashEnergyTableEntry.prototype.setDataTables = function( dataTables ) {
    this.dataTables = dataTables;
}
SplashEnergyTableEntry.prototype.isDataTables = function( ) {
    return ( this.dataTables != null );
}
SplashEnergyTableEntry.prototype.getDataTables = function( ) {
    return this.dataTables;
}

SplashEnergyTableEntry.prototype.draw = function( ) {
    console.log( timestamp() + " SplashEnergyTableEntry.draw()");
    var obj = this;
    var energy = this.getEnergy();
    var ref = energy.getRef();

	var rowExistInDatables = false;
	var dataTablesRowIndex = 0;
    if ( this.isDataTables() ) {
		var dataTables = this.getDataTables();
		// Find indexes of rows which have ref in the second column
		dataTables.rows().eq( 0 ).filter( function (rowIdx) {
			if ( dataTables.cell( rowIdx, 1 ).data() == ref ) {
				rowExistInDatables = true;
				dataTablesRowIndex = rowIdx;
			}
		});
	}
	
    // Does the element exist? No: draw, Yes: update
    if ( $('#sete_' + ref).length || rowExistInDatables ) {
        console.log( timestamp() + " SplashEnergyTableEntry.draw() - Update the element");

        if ( this.isDataTables() ) {

			// Find indexes of rows which have ref in the second column
			var row = dataTables.row( dataTablesRowIndex );
			dataTables.cell( dataTablesRowIndex, 2 ).data( energy.getLocation2() );
			dataTables.cell( dataTablesRowIndex, 3 ).data( energy.getLocation() );
			dataTables.cell( dataTablesRowIndex, 4 ).data( energy.getName()  );

            if ( typeof energy.getStatus() == "string" ) {
                if ( energy.getStatus().includes("kWh") || energy.getStatus().includes("kW Hours") ) {
                    dataTables.cell( dataTablesRowIndex, 5 ).data( Math.round( energy.getValue() * 1000 ) /1000 );
					dataTables.cell( dataTablesRowIndex, 6 ).data( "kWh" );		 // Eenheid
                } else if ( energy.getStatus().includes("kW") ) {
                    // Convert from kW to Watts
                    dataTables.cell( dataTablesRowIndex, 5 ).data( Math.round( energy.getValue() * 1000 ) );
					dataTables.cell( dataTablesRowIndex, 6 ).data( "W" );		 // Eenheid
                } else if ( energy.getStatus().includes("Wh") ) {
                    // Convert from Wh to kWh
                    dataTables.cell( dataTablesRowIndex, 5 ).data( Math.round( energy.getValue() ) / 1000 );
                    dataTables.cell( dataTablesRowIndex, 6 ).data( "kWh" );       // Eenheid
                } else if ( energy.getStatus().includes("W") || energy.getStatus().includes("Watt") ) {
                    dataTables.cell( dataTablesRowIndex, 5 ).data( Math.round( energy.getValue() * 1000 ) /1000 );
                    dataTables.cell( dataTablesRowIndex, 6 ).data( "W" );       // Eenheid
                } else if ( energy.getStatus().includes("m3") ) {
                    dataTables.cell( dataTablesRowIndex, 5 ).data( Math.round( energy.getValue() * 1000 ) /1000 );
                    dataTables.cell( dataTablesRowIndex, 6 ).data( "m" + "3".sup() );       // Eenheid
                } else {
		            $.each( hsDevices, function( index, value ) {
                        dataTables.cell( dataTablesRowIndex, 5 ).data( Math.round( energy.getValue() * 1000 ) /1000 );
		                if ( value[0] == ref ) {
		                	switch ( value[2] ) {
								case 'SplashEnergyDevice':
				                    dataTables.cell( dataTablesRowIndex, 6 ).data( "kWh" );       // Eenheid
									break;
								case 'SplashPowerDevice':
			                	    dataTables.cell( dataTablesRowIndex, 6 ).data( "W" );      	  // Eenheid
									break;
								default:
			                	    dataTables.cell( dataTablesRowIndex, 6 ).data( "..." );       // Eenheid
									break;
		                	}
		                }
		            });
			...
			dataTables.draw( false );	// false indicates no reset of the paging

        } else {

            $('#sete_' + ref + ' .energy_col_1').html( $('#sete_' + ref).index() +1 ); // row number
            $('#sete_' + ref + ' .energy_col_2').html( ref );    // RefId
            $('#sete_' + ref + ' .energy_col_3').html( energy.getLocation2() );    // Locatie
            $('#sete_' + ref + ' .energy_col_4').html( energy.getLocation() );     // Locatie
            $('#sete_' + ref + ' .energy_col_5').html( energy.getName() );         // Device
    //        $('#sete_' + ref + ' .energy_col_5').attr( 'data-original-title', 'ref: '+energy.getRef() );


            if ( typeof energy.getStatus() == "string" ) {
                if ( energy.getStatus().includes("kWh") || energy.getStatus().includes("kW Hours") ) {
                    $('#sete_' + ref + ' .energy_col_6').html( Math.round( energy.getValue() * 1000 ) /1000 );       // Waarde
                    $('#sete_' + ref + ' .energy_col_7').html( "kWh" );       // Eenheid
                } else if ( energy.getStatus().includes("kW") ) {
                    // Convert from kW to Watts
                    $('#sete_' + ref + ' .energy_col_6').html( Math.round( energy.getValue() * 1000 ) );       // Waarde
                    $('#sete_' + ref + ' .energy_col_7').html( "W" );       // Eenheid
                } else if ( energy.getStatus().includes("Wh") ) {
                    // Convert from Wh to kWh
                    $('#sete_' + ref + ' .energy_col_6').html( Math.round( energy.getValue() ) /1000 );       // Waarde
                    $('#sete_' + ref + ' .energy_col_7').html( "kWh" );       // Eenheid
                    ...
                    $('#sete_' + ref + ' .energy_col_6').html( Math.round( energy.getValue() * 1000 ) /1000 );       // Waarde
                    $('#sete_' + ref + ' .energy_col_7').html( "m" + "3".sup() );       // Eenheid
                } else {
		            $.each( hsDevices, function( index, value ) {
                        $('#sete_' + ref + ' .energy_col_6').html( Math.round( energy.getValue() * 1000 ) /1000 );       // Waarde
		                if ( value[1] == ref ) {
		                	switch ( value[2] ) {
								...
								case 'SplashPowerDevice':
									...
									break;
								default:
			                	    $('#sete_' + ref + ' .energy_col_7').html( "..." );      	// Eenheid
									break;
		                	}
		                }
		            });
        ...
        // Element dows not exist, draw it
        console.log( timestamp() + " SplashEnergyTableEntry.draw() - Drawing new element");
        ...
        if ( this.isDataTables() ) {
            ...
            var row = dataTables.row.add( [
				...
				.draw()
				.node();
			$( row ).attr( 'id', 'sete_' + ref );
			$( row ).addClass( 'settings_row' );

			
        } else {
            var elStr = `<tr id="sete_TOKEN_ID" class="settings_row">
                    <td class="energy_col_1" scope="row">..</th>
                    <td class="energy_col_2">TOKEN_ID</td>
                    <td class="energy_col_3">..</td>
                    <td class="energy_col_4 text-center">..</td>
                    <td class="energy_col_5 text-left" id="sete_TOKEN_ID_ref" data-toggle="tooltip" data-placement="bottom" title="ref: TOKEN_ID">..</td>
                    <td class="energy_col_6 text-right" id="sete_TOKEN_ID_cost" data-toggle="tooltip" data-placement="bottom" title="">..</td>
                    <td class="energy_col_7 text-left"></th>
                    <td class="energy_col_8"><i class="mdi mdi-battery-charging-40"> </i></th>
                </tr>`;

            elStr = elStr.replace( /TOKEN_ID/g, ref );
                    
            $( this.getBindingElement() + ' tbody' ).append( elStr );
            $('#sete_'+ref+'_ref').tooltip(); 
            $('#sete_'+ref+'_cost').tooltip(); 
        }
        // HSUpdateHandler gets the value straigt from HomeSeer, DBEventsValueUpdateHandler gets the most recent value
        // from the Events database table, and DBEnergyValueUpdateHandler from the Energy table.
        CentralSplashUpdater.register( energy.getRef(), DBEnergyValueUpdateHandler, function() { obj.draw() } );
    }
}

// ----------------------- Homeseer Energy Graph Object ------------------------------------------
// Graph of Daily Energy values, or individual Events.
function SplashDataObj( data, type = "kWh" ) {
	this.data = data.map(function(o){return [ new Date(o[0]).getTime(), parseFloat(o[1]) ];});
	this.type = type;
	this.min = null;		this.setMin();
	this.tsMin = null;		this.setTsMin();
	this.tsMinTxt = null;	this.setTsMinTxt();
	this.max = null;		this.setMax();
	this.tsMax = null;		this.setTsMax();
	this.tsMaxTxt = null;	this.setTsMaxTxt();
}
SplashDataObj.prototype.getData = function( ) { return this.data; }
SplashDataObj.prototype.deleteTsEntry = function( d ) { this.data = this.data.filter(function(o){ return o[0] != d.getTime(); }); this.calculateMinMax(); };
SplashDataObj.prototype.getType = function( ) { return this.type; }
SplashDataObj.prototype.getMin = function( ) { return this.min; }
SplashDataObj.prototype.setMin = function( min = null ) { if ( min != null ) { this.min = min; } else { this.min = Math.min.apply(null, this.data.map(function(o) {return parseFloat(o[1]); })); } }
SplashDataObj.prototype.getTsMin = function( ) { return this.tsMin; }
SplashDataObj.prototype.setTsMin = function( tsMin = null ) { if ( tsMin != null ) { this.tsMin = tsMin; } else { this.tsMin = new Date(Math.min.apply(null, this.data.map(function(o){return new Date(o[0]).getTime(); }))); } };
SplashDataObj.prototype.getTsMinTxt = function( ) { return this.tsMinTxt; }
SplashDataObj.prototype.setTsMinTxt = function( tsMinTxt = null ) { if ( tsMinTxt != null ) { this.tsMinTxt = tsMinTxt; } else { this.tsMinTxt = formatDate(new Date(this.tsMin), "yyyy-MM-dd HH:mm:ss"); } };
SplashDataObj.prototype.getMax = function( ) { return this.max; }
SplashDataObj.prototype.setMax = function( max = null ) { if ( max != null )  { this.max = max; } else { this.max = Math.max.apply(null, this.data.map(function(o){return parseFloat(o[1]);})); } };
SplashDataObj.prototype.getTsMax = function( ) { return this.tsMax; }
SplashDataObj.prototype.setTsMax = function( tsMax = null ) { if ( tsMax != null )  { this.tsMax = tsMax; } else { this.tsMax = new Date(Math.max.apply(null, this.data.map(function(o){return new Date(o[0]).getTime();}))); } };
SplashDataObj.prototype.getTsMaxTxt = function( ) { return this.tsMaxTxt; }
SplashDataObj.prototype.setTsMaxTxt = function( tsMaxTxt = null ) { if ( tsMaxTxt != null )  { this.tsMaxTxt = tsMaxTxt; } else { this.tsMaxTxt = formatDate(new Date(this.tsMax), "yyyy-MM-dd HH:mm:ss"); } };
SplashDataObj.prototype.calculateMinMax = function() { this.setMin(); this.setTsMin(); this.setTsMinTxt(); this.setMax(); this.setTsMax(); this.setTsMaxTxt(); }; 
...
function SplashEnergyGraph( name ) {
    ...
    // Default width class. Works with col-lg-4, col-lg-6 and col-12
    this.widthClass = 'col-lg-3';   // col-lg-3 col-md-6
    this.portletClass = 'portlet-default';   //  portlet-default bg-primary bg-info bg-success bg-warning bg-danger bg-inverse bg-pink bg-purple

    this.refList = [];
    this.flotGraph = null;
    this.stacked = false;
}
Object.defineProperty(SplashEnergyGraph, "SOURCE_TYPE_EVENTS", { value: 1 });	// Events db table
Object.defineProperty(SplashEnergyGraph, "SOURCE_TYPE_ENERGY", { value: 2 });	// Energy db table
Object.defineProperty(SplashEnergyGraph, "SOURCE_TYPE_DIRECTDATA", { value: 3 });		// Data provided in element
Object.defineProperty(SplashEnergyGraph, "GRAPH_TYPE_LINES", { value: 1 });
Object.defineProperty(SplashEnergyGraph, "GRAPH_TYPE_BARS", { value: 2 });
...
SplashEnergyGraph.prototype.setPortletClass = function( portletClass ) {
    this.portletClass = portletClass;
}
SplashEnergyGraph.prototype.getPortletClass = function( ) {
    return this.portletClass;
}
SplashEnergyGraph.prototype.addElement = function( el ) {
	if ( el.sourceType == undefined) {
		el.sourceType = SplashEnergyGraph.SOURCE_TYPE_ENERGY;
	}
	if ( el.legend == undefined) {
		el.legend = true;
	}
	if ( el.graphType == undefined) {
		el.graphType = SplashEnergyGraph.GRAPH_TYPE_LINES;
	}
	if ( el.sourceType == SplashEnergyGraph.SOURCE_TYPE_DIRECTDATA ) {
		// Local data object
		el.obj = new SplashDataObj( el.data );
	} else {
		el.obj = HSGraphEventDataDeviceFactory.create( el.ref );
	}
    this.refList.push( el );
}
SplashEnergyGraph.prototype.getElement = function( ref ) {
	var obj = this;
	var el = null;
    $.each( obj.refList, function( index, value ) {
        if ( value.ref == ref ) {
			el = value;
			return false;	// break
		}
...
SplashEnergyGraph.prototype.setStacked = function( stacked ) {
   this.stacked = ( stacked ? true : false );
}
SplashEnergyGraph.prototype.isStacked = function( ) {
   return this.stacked;
}

SplashEnergyGraph.prototype.draw = function( ) {
    console.log( timestamp() + " SplashEnergyGraph.draw()");

    var obj = this;


        var d = (new Date(new Date().getFullYear(), new Date().getMonth(), (new Date().getDate() - 7), new Date().getHours(), new Date().getMinutes())).getTime();
        // 1h = 60 * 60 * 1000ms = 21660000ms 
        data1 = [ [d +  0 * 21660000, 377.03], [d +  6 * 21660000, 377.87], [d + 12 * 21660000, 378.88], [d + 18 * 21660000, 380.42], 
                  [d + 24 * 21660000, 380.62], [d + 30 * 21660000, 379.70], [d + 36 * 21660000, 377.43], [d + 42 * 21660000, 376.32], 
                  [d + 48 * 21660000, 374.19], [d + 54 * 21660000, 374.47], [d + 60 * 21660000, 376.15], [d + 66 * 21660000, 377.51], 
                  [d + 72 * 21660000, 378.43], [d + 78 * 21660000, 379.70], [d + 84 * 21660000, 380.92], [d + 90 * 21660000, 382.18] ];

        data2 = [ [d +  0 * 21660000, 387.03], [d +  6 * 21660000, 387.87], [d + 12 * 21660000, 388.88], [d + 18 * 21660000, 390.42], 
                  [d + 24 * 21660000, 390.62], [d + 30 * 21660000, 389.70], [d + 36 * 21660000, 387.43], [d + 42 * 21660000, 386.32], 
                  [d + 48 * 21660000, 384.19], [d + 54 * 21660000, 384.47], [d + 60 * 21660000, 386.15], [d + 66 * 21660000, 387.51], 
                  [d + 72 * 21660000, 388.43], [d + 78 * 21660000, 389.70], [d + 84 * 21660000, 390.92], [d + 90 * 21660000, 392.18] ];
/*        $.each( obj.refList, function( index, value ) {
            if ( value.obj.getData() != null ) {
            	if ( value.obj.getUid() == 99999 ) {
            		value.obj.setData( data1 );
            		value.obj.setMin( 374.19 );
            		value.obj.setMax( 382.18 );
				}
            	if ( value.obj.getUid() == 874 ) {
            		value.obj.setData( data2 );
            		value.obj.setMin( 384.19 );
            		value.obj.setMax( 392.18 );
				}
            } 
		});
*/
    ...
    // Does the element exist? No: draw, Yes: update
    if ( $('#seg_' + obj.uniqueId).length ) {
        console.log( timestamp() + " SplashEnergyGraph.draw() - Update the element");

        // Build the dataset
        var newYMin = 0, newYMax = 0;
        var flotDataset = []
        var yaxes = [];
        $.each( obj.refList, function( index, value ) {
            if ( value.obj.getData() == null ) {
                // This element is not yet updated
                return true;   // 'return false' breaks the each, 'return true' goes to the next iteration
            }

            // Normalize
            if ( typeof value.obj.getType() == 'string' ) {
                if ( value.obj.getType() == 'Wh' ) {
                    // Convert from Wh to kWh
                    $.each( value.obj.getData(), function( index, dataValue ) {
                        dataValue[1] = dataValue[1] / 1000;
                    });
                    value.obj.setMin( value.obj.getMin() / 1000 );
                    value.obj.setMax( value.obj.getMax() / 1000 );
                    value.obj.setType( 'kWh' );
                } else if ( value.obj.getType() == 'kW' ) {
                    ...
                    value.obj.setMax( value.obj.getMax() * 1000 );
                    value.obj.setType( 'W' );
                } else if ( value.obj.getType() == 'temp' ) {
                    // Don't convert
                }
            }

        	var dataset = {
                data: ( value.obj.getData() != null ? value.obj.getData() : [] )
            };
			if ( value.label != undefined ) { dataset.label = value.label; }
			if ( value.obj.getType() != undefined ) { 
				switch ( value.obj.getType() ) {
					case 'temp':
						dataset.label += ' [&#8451;]'; 
						break;
					case 'W':
					case 'kWh':
					default:
						dataset.label += ' [' + value.obj.getType() + ']'; 
				}
			}
			if ( value.color != undefined ) { dataset.color = value.color; } 
			if ( value.lines != undefined && value.lines.fillColor != undefined ) { dataset.lines.fillColor = value.lines.fillColor; } 
            // Build the yaxes, combine if the same unit
            if ( typeof value.obj.getType() == 'string' ) {
                if ( yaxes[ value.obj.getType() ] == undefined ) {
                    // the index of this axis
                    yaxes[ value.obj.getType() ] = [];
                    yaxes[ value.obj.getType() ].index = ( Object.keys(yaxes).length -1 );  // 1 based -> 0 based
                    yaxes[ value.obj.getType() ].min = value.obj.getMin();
                    yaxes[ value.obj.getType() ].max = value.obj.getMax();
                    if ( yaxes[ value.obj.getType() ].max > 10000 ) {
                        yaxes[ value.obj.getType() ].max = Math.ceil( yaxes[ value.obj.getType() ].max /10000 ) * 10000;
                    } else if ( yaxes[ value.obj.getType() ].max > 1000 ) {
                        yaxes[ value.obj.getType() ].max = Math.ceil( yaxes[ value.obj.getType() ].max /1000 ) * 1000;
                    } else if ( yaxes[ value.obj.getType() ].max > 100 ) {
                        yaxes[ value.obj.getType() ].max = Math.ceil( yaxes[ value.obj.getType() ].max /100 ) * 100;
                    } else if ( yaxes[ value.obj.getType() ].max > 10 ) {
                        yaxes[ value.obj.getType() ].max = Math.ceil( yaxes[ value.obj.getType() ].max /10 ) * 10;
                    }
                    if ( yaxes[ value.obj.getType() ].min > 10000 ) {
                        yaxes[ value.obj.getType() ].min = Math.floor( yaxes[ value.obj.getType() ].min /10000 ) * 10000;
                    } else if ( yaxes[ value.obj.getType() ].min > 1000 ) {
                        yaxes[ value.obj.getType() ].min = Math.floor( yaxes[ value.obj.getType() ].min /1000 ) * 1000;
                    } else if ( yaxes[ value.obj.getType() ].min > 100 ) {
                        yaxes[ value.obj.getType() ].min = Math.floor( yaxes[ value.obj.getType() ].min /100 ) * 100;
                    } else if ( yaxes[ value.obj.getType() ].min > 10 ) {
                        yaxes[ value.obj.getType() ].min = Math.floor( yaxes[ value.obj.getType() ].min /10 ) * 10;
                    }
                    yaxes[ value.obj.getType() ].fontColor = value.color ;  // Try to use the dataset specific color
                } else {
                    if ( obj.isStacked() ) {
                        yaxes[ value.obj.getType() ].min = Math.min( yaxes[ value.obj.getType() ].min, value.obj.getMin() );
                        yaxes[ value.obj.getType() ].max = yaxes[ value.obj.getType() ].max + value.obj.getMax();
                    } else {
                        yaxes[ value.obj.getType() ].min = Math.min( yaxes[ value.obj.getType() ].min, value.obj.getMin() );
                        yaxes[ value.obj.getType() ].max = Math.max( yaxes[ value.obj.getType() ].max, value.obj.getMax() );
                    }
					// Issue is that some yaxis is already drawn in specific color, and this just draws the new yaxis values in 
					// a specific color. To prevent color mismatch, keep the original color for now.
//                    yaxes[ value.obj.getType() ].fontColor = '#98a6ad';     // Multiple datasets for one yaxis, use generic color
                }
                value.yaxis = yaxes[ value.obj.getType() ].index +1;
                dataset.yaxis = yaxes[ value.obj.getType() ].index +1;  // requires 1 based, so +1
            }
			if ( value.graphType == SplashEnergyGraph.GRAPH_TYPE_LINES ) { 
				dataset.lines = {
					show: true
				};
				dataset.lines.steps = ( ( value.lines != undefined && value.lines.steps != undefined ) ? value.lines.steps : false );
				dataset.lines.lineWidth = ( ( value.lines != undefined && value.lines.lineWidth != undefined ) ? value.lines.lineWidth : 1 );
				dataset.lines.fill = ( ( value.lines != undefined && value.lines.fill != undefined ) ? value.lines.fill : 0.3 );
				dataset.points = ( ( value.points != undefined ) ? value.points : { show: false } );
			} 
			if ( value.graphType == SplashEnergyGraph.GRAPH_TYPE_BARS ) { 
				dataset.bars = {
					show: true
				};
				dataset.bars.fill = ( ( value.bars != undefined && value.bars.fill != undefined ) ? value.bars.fill : 1 );
				dataset.bars.align = ( ( value.bars != undefined && value.bars.align != undefined ) ? value.bars.align : 'center' );
				dataset.bars.lineWidth = ( ( value.bars != undefined && value.bars.lineWidth != undefined ) ? value.bars.lineWidth : 0 );
				// x width devided by 2x the datapoints
				dataset.bars.barWidth = ( ( value.bars != undefined && value.bars.barWidth != undefined ) ? value.bars.barWidth : ( ( value.obj.getTsMax() - value.obj.getTsMin() ) / ( value.obj.getData().length * (Object.keys( obj.refList ).length +1) ) ) );

                // If type is bars, more than one dataset, and not stacked, place them next to each other. Shift the bar the index +1 [1, 2, 3] times the bar width
                $.each( value.obj.getData(), function( index, dataValue ) {
                    dataValue[0] += ( ( ( value.obj.getTsMax() - value.obj.getTsMin() ) / ( value.obj.getData().length * (Object.keys( obj.refList ).length +1) ) ) * value.yaxis );
                });
                // dataset.bars.order = true;

			} 
            flotDataset.push( dataset );
        });
        obj.flotGraph.setData( flotDataset );

		// Convert assiciated array to numeric array
		for (var yaxis in yaxes) {	// requires 0 based index!
			if ( obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ] == undefined ) { 
			    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ] = [];	// all yaxes should already exist!!
			}
		    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ].min = yaxes[yaxis].min;
		    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ].max = yaxes[yaxis].max;
		    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ].font = { color: yaxes[yaxis].fontColor };
		    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ].alignTicksWithAxis = 1; //1;		// 1 or null,
		    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ].position = ( ( yaxes[yaxis].index % 2 ) == 0 ? 'left' : 'right' );			// left or right
		    obj.flotGraph.getOptions().yaxes[ yaxes[yaxis].index ].tickFormatter = function (v, axis) {
		    	var unitPostfix = "";
    	        $.each( obj.refList, function( index, value ) {
					if ( value.yaxis == axis.n ) {
						switch ( value.obj.getType() ) {
							case 'temp':
								unitPostfix = '&#8451;';
								break;
							...
							case 'kWh':
							default:
								unitPostfix = value.obj.getType();
						}
                        return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
					}
				});
				return ( v.toFixed(axis.tickDecimals) + unitPostfix );
		    };
		}

        $('#seg_' + obj.uniqueId + '_waiting').toggleClass( 'invisible', true );

        obj.flotGraph.setupGrid();
        obj.flotGraph.draw();
        ...
        var elStr = `<div id="seg_TOKEN_ID" class="TOKEN_WIDTHCLASS">
            <div class="portlet"><!-- /primary heading -->
                <div class="portlet-heading TOKEN_PORTLETCLASS" style="height: 60px;">
                    <h3 class="portlet-title text-dark">TOKEN_NAME</h3>
                    <div class="clearfix"></div>
                    <div class="btn-group" style="position: absolute; top: 10px; right: 30px;">
                        <button type="button" id="seg_TOKEN_ID_year" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;"> Jaar </button>
                        <button type="button" id="seg_TOKEN_ID_month" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;"> Maand </button>
                        <button type="button" id="seg_TOKEN_ID_week" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;"> Week </button>
                        <button type="button" id="seg_TOKEN_ID_day" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;"> Dag </button>
                   </div>
                    <div id="seg_TOKEN_ID_zoomButtons" class="btn-group" style="position: absolute; top: 63px; left: 67px;">
                    ...
                    <div id="seg_TOKEN_ID_legendaToggle" class="btn-group" style="position: absolute; top: 64px; left: 150px;">
                        <button type="button" id="seg_TOKEN_ID_toggleLegenda" class="btn btn-outline-secondary btn-sm waves-effect waves-light" style="width: 38px;" onclick="flotGraphs[ 'seg_TOKEN_ID' ].getOptions().legend.show = (! ( flotGraphs[ 'seg_TOKEN_ID' ].getOptions().legend.show ) ); flotGraphs[ 'seg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'seg_TOKEN_ID' ].draw();"> <i class="ion-map"></i> </button>
                   </div>
                </div>
        ...
        elStr = elStr.replace( /TOKEN_ID/g, obj.uniqueId );
        elStr = elStr.replace( /TOKEN_NAME/g, obj.getName() );
        elStr = elStr.replace( /TOKEN_WIDTHCLASS/g, obj.getWidthClass() );
        elStr = elStr.replace( /TOKEN_PORTLETCLASS/g, obj.getPortletClass() );
                
        $( obj.getBindingElement() ).append( elStr );

        // Multiple datasets, then hide the zoom buttons
        if ( Object.keys( obj.refList ).length > 1 ) { 
            $('div#seg_' + obj.uniqueId + '_legendaToggle').css( 'top', $('div#seg_' + obj.uniqueId + '_zoomButtons').css( 'top' ) );
            $('div#seg_' + obj.uniqueId + '_legendaToggle').css( 'left', $('div#seg_' + obj.uniqueId + '_zoomButtons').css( 'left' ) );
            $('div#seg_' + obj.uniqueId + '_zoomButtons').hide();
        }

		// yaxes are dynamic, they should only show up if there are datasets associated with them. Therefore 
		// create an axis per dataset, determine later wheter it will be used or not.
        var flotDataset = [];
        var yaxes = [];
        var color = [];
		var xmin = null;
        ...
        $.each( obj.refList, function( index, value ) {
        	if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_DIRECTDATA ) {
	        	var dataset = {
	                data: value.obj.getData(),
	                label: value.label + ' [' + value.obj.getType() + ']',
					lines: {
						show: true,
						steps: ( ( value.lines != undefined && value.lines.steps != undefined ) ? value.lines.steps : false ),
						lineWidth: ( ( value.lines != undefined && value.lines.lineWidth != undefined ) ? value.lines.lineWidth : 1 ),
						fill: ( ( value.lines != undefined && value.lines.fill != undefined ) ? value.lines.fill : 0.3 ),
						points: ( ( value.points != undefined ) ? value.points : { show: false } )
					}
	            };
				flotDataset.push( dataset );	// Data directly provided
				if ( xmin == null ) { xmin = value.obj.getTsMin().getTime(); } else { xmin = Math.min( value.obj.getTsMin().getTime(), xmin ); }
				if ( xmax == null ) { xmax = value.obj.getTsMax().getTime(); } else { xmax = Math.max( value.obj.getTsMax().getTime(), xmin ); }
        	} else {
				flotDataset.push( { } );	// Data to be retrieved, Just jam empty datasets
        	}
			color.push( value.color );	// Data directly provided
			yaxes.push( { position: ( yaxes.length % 2 == 0 ? 'left' : 'right' ) } ); // Alternatively place axes left and right
        });
		if ( xmin == null ) { xmin = (new Date(new Date().getFullYear(), new Date().getMonth(), (new Date().getDate() - 7), new Date().getHours(), new Date().getMinutes())).getTime(); }
		if ( xmax == null ) { xmax = (new Date()).getTime(); }
		var minTickSize = [2, "hours"];	// Default 1 day
		if ( ( xmax - xmin ) > 24 * 60 * 60 * 1000 ) {
            minTickSize = [1, "day"];	// 1 week
		}
		if ( ( xmax - xmin ) > 7 * 24 * 60 * 60 * 1000 ) {
            minTickSize = [2, "day"];	// 1 month
		}
		if ( ( xmax - xmin ) > 60 * 24 * 60 * 60 * 1000 ) {
            minTickSize = [1, "month"];	// 1 year
		}

        obj.flotGraph = $.plot($("#seg_"+obj.uniqueId+"_flotgraph"), flotDataset, {
            legend: {
                position: 'ne',
                ...
                content: function(label, xval, yval, flotItem) {
			        ...
			        $.each( obj.refList, function( index, value ) {
	      				switch ( value.obj.getType() ) {
							...
							case 'kWh':
							default:
								if ( label == value.label + ' [' + value.obj.getType() + ']' ) {
									switch ( value.obj.getType() ) {
										case 'temp':
											yAxisUnit = '&#8451;';
											break;
                    ...
                    return '<span style="z-index: 9999; color: ' + flotItem.series.color + '; font-weight: bold;"> ' + label +'</span><br>' + 
                    	yval + ( yAxisUnit != null ? yAxisUnit : '' ) + 
                    	( yAxisUnit == 'kWh' ? ' &euro; ' + (Math.round( (pricePer_kWh * yval) *100) /100).toFixed(2) : 
                    		( yAxisUnit == 'Wh' ? ' &euro; ' + (Math.round( (( pricePer_kWh / 1000 ) * yval) *100) /100).toFixed(2) : 
                    			'' 
                    		) 
                    	) + 
                    	'<br><i class="fa fa-calendar"></i> ' + 
                    		d.getDate() + " " + 
                    		monthToStr( nl_NL, d.getMonth() ) + " " + 
                    		d.getFullYear() + 
...
//                twelveHourClock: false,
		...
		if ( obj.isStacked() ) {
			obj.flotGraph.getOptions().series = {
            	stack: true
            };
		}

        flotGraphs[ 'seg_' + obj.uniqueId ] = obj.flotGraph;

        $('#seg_'+obj.uniqueId+'_flotgraph').bind("plotpan", function (event, plot) {
        });

        $('#seg_'+obj.uniqueId+'_flotgraph').bind("plotzoom", function (event, plot) {
		...
		// One year
		$("button#seg_" + obj.uniqueId + "_year").click( function() {
			// Set the new timeframe
			var d = new Date(); d.setFullYear( d.getFullYear() -1 );
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].min = d.getTime(); 
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].tickSize = [ 1, 'month' ]; 
			flotGraphs[ 'seg_' + obj.uniqueId ].setupGrid();
			flotGraphs[ 'seg_' + obj.uniqueId ].draw();
	        $.each( obj.refList, function( key, value ) {
				if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_ENERGY ||
					 value.sourceType == SplashEnergyGraph.SOURCE_TYPE_EVENTS ) {
					value.hsgdbduHandler.start = Math.floor( d.getTime() / 1000 );
					// Trigger a refresh
					CentralSplashUpdater.update( value.hsgdbduHandler.uidt, value.ref );
				}
	        });
		});
		// One Month
		$("button#seg_" + obj.uniqueId + "_month").click( function() {
			// Set the new timeframe
			var d = new Date(); d.setMonth( d.getMonth() -1 );
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].min = d.getTime(); 
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].tickSize = [ 2, 'day' ]; 
			flotGraphs[ 'seg_' + obj.uniqueId ].setupGrid(); 
			flotGraphs[ 'seg_' + obj.uniqueId ].draw();			
	        $.each( obj.refList, function( key, value ) {
				if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_ENERGY ||
		...
		// One Week
		$("button#seg_" + obj.uniqueId + "_week").click( function() {
			// Set the new timeframe
			var d = new Date(); d.setDate( d.getDate() -7 );
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].min = d.getTime();
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].tickSize = [ 1, 'day' ]; 
			flotGraphs[ 'seg_' + obj.uniqueId ].setupGrid();
			flotGraphs[ 'seg_' + obj.uniqueId ].draw();
	        $.each( obj.refList, function( key, value ) {
				if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_ENERGY ||
		...
		// One Day
		$("button#seg_" + obj.uniqueId + "_day").click( function() {
			// Set the new timeframe
			var d = new Date(); d.setDate( d.getDate() -1 );
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].min = d.getTime();
			flotGraphs[ 'seg_' + obj.uniqueId ].getOptions().xaxes[0].tickSize = [ 2, 'hour' ];
			flotGraphs[ 'seg_' + obj.uniqueId ].setupGrid(); 
			flotGraphs[ 'seg_' + obj.uniqueId ].draw();
	        $.each( obj.refList, function( key, value ) {
				if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_ENERGY ||
        ...
        $.each( obj.refList, function( key, value ) {
			if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_ENERGY ) {
				value.hsgdbduHandler = new HSGraphDbDataUpdateHandler();
				value.hsgdbduHandler.setSourceToEnergy();				
	            CentralSplashUpdater.register( value.ref, value.hsgdbduHandler, function() { obj.draw() } );
			} else if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_EVENTS ) {
				value.hsgdbduHandler = new HSGraphDbDataUpdateHandler();
				value.hsgdbduHandler.setSourceToEvents();				
	            CentralSplashUpdater.register( value.ref, value.hsgdbduHandler, function() { obj.draw() } );
			} else if ( value.sourceType == SplashEnergyGraph.SOURCE_TYPE_DIRECTDATA ) {
				// Data directly provided
			} else {
				console.error( 'SplashEnergyGraph - unknown source type ' );
			}
        });
...
SplashEnergyGraph.prototype.destroy = function( ) {
    console.log( timestamp() + " SplashEnergyGraph.destroy()");

    var obj = this;
    
    // Does the element exist? Yes: remove
    if ( $('#seg_' + obj.uniqueId).length ) {
		$('#seg_' + obj.uniqueId).remove();
	}
    obj.flotGraph.shutdown( );
    obj.flotGraph = null;
}

// ----------------------- Homeseer Total Energy Graph Object ------------------------------------------
// Shows the netto consumption, the netted return, and the bruto consumption
//
// Depending on the day being a netto consumer or netto producer:
//    netto consumer:								netto producer
//    - Return 				dark gray			- Consumption (gross)	gray/orange
//    - Generation - Return	light gray			- return (negative)		green
//    - Consumption (gross)	orange
//    Total generation is the top two				Total production is both elements combined.
//    elements.


// !!! Need to the a stackbar plugin to allow negative values to be stacked up!!!
// https://github.com/ericliao/flot-stackbars

function SplashTotalEnergyConsumptionAndProductionGraph( name, gridConsumptionRef, gridReturnRef, solarProductionRef ) {
    // Element tot attach it to
    this.name = name;
    this.uniqueId = makeId( 5 );
    this.bindingElement = null;
    ...
    this.gridConsumption = HSGraphEventDataDeviceFactory.create( gridConsumptionRef );
    this.gridReturn = HSGraphEventDataDeviceFactory.create( gridReturnRef );
    this.solarProduction = HSGraphEventDataDeviceFactory.create( solarProductionRef );

    this.flotGraph = null;

    this.dsSolarProduction = [];
    this.dsTotalConsumption = [];
    this.dsGridReturn = []; 
    this.dsGridConsumption = []; 

    this.dsReturnProduction = [];
    this.dsUsedProduction = [];
    this.dsNetConsumed = [];
    this.dsNetReturn = [];

}
SplashTotalEnergyConsumptionAndProductionGraph.prototype.getName = function( ) {
    return this.name;
}
SplashTotalEnergyConsumptionAndProductionGraph.prototype.setBindingElement = function( bindingElement ) {
    this.bindingElement = bindingElement;
}
SplashTotalEnergyConsumptionAndProductionGraph.prototype.getBindingElement = function( ) {
    return this.bindingElement;
}
SplashTotalEnergyConsumptionAndProductionGraph.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashTotalEnergyConsumptionAndProductionGraph.prototype.getWidthClass = function( ) {
    return this.widthClass;
}
SplashTotalEnergyConsumptionAndProductionGraph.prototype.getGridConsumption = function( ) {
    return this.gridConsumption;
};
SplashTotalEnergyConsumptionAndProductionGraph.prototype.getGridReturn = function( ) {
    return this.gridReturn;
};
SplashTotalEnergyConsumptionAndProductionGraph.prototype.getSolarProduction = function( ) {
    return this.solarProduction;
};

SplashTotalEnergyConsumptionAndProductionGraph.prototype.draw = function( ) {
    console.log( timestamp() + " SplashTotalEnergyConsumptionAndProductionGraph.draw()");

    var obj = this;
    
    // Does the element exist? No: draw, Yes: update
    if ( $('#stecapg_' + obj.uniqueId).length ) {
        console.log( timestamp() + " SplashTotalEnergyConsumptionAndProductionGraph.draw() - Update the element");

        // Build the dataset
        var newYMin = null, newYMax = null;
        var flotDataset = [];
        
        var flotDataStructure = [];
        // GridConsumption  measured amound of energy taken from the grid this day.
        // GridReturn       measured amount of energy returned to the grid this day.
        // SolarProduction  is the total amount produced this day by the solar panels, consumed or net returned.
        // Create the dataset - first build structure
        $.each( obj.getGridConsumption().getData(), function( index, value ) {
        	if ( ! ( value[0] in flotDataStructure ) ) { flotDataStructure[ value[0] ] = []; }
        	flotDataStructure[ value[0] ]['GridConsumption'] = value[1];
            if ( ! ( 'GridReturn' in flotDataStructure[ value[0] ] ) ) { flotDataStructure[ value[0] ]['GridReturn'] = 0; }
            if ( ! ( 'SolarProduction' in flotDataStructure[ value[0] ] ) ) { flotDataStructure[ value[0] ]['SolarProduction'] = 0; }
        });
        $.each( obj.getGridReturn().getData(), function( index, value ) {
        	if ( ! ( value[0] in flotDataStructure ) ) { flotDataStructure[ value[0] ] = []; }
        	if ( ! ( 'GridConsumption' in flotDataStructure[ value[0] ] ) ) { flotDataStructure[ value[0] ]['GridConsumption'] = 0; }
        	flotDataStructure[ value[0] ]['GridReturn'] = value[1];
            if ( ! ( 'SolarProduction' in flotDataStructure[ value[0] ] ) ) { flotDataStructure[ value[0] ]['SolarProduction'] = 0; }
        });
        $.each( obj.getSolarProduction().getData(), function( index, value ) {
        	if ( ! ( value[0] in flotDataStructure ) ) { flotDataStructure[ value[0] ] = []; }
        	if ( ! ( 'GridConsumption' in flotDataStructure[ value[0] ] ) ) { flotDataStructure[ value[0] ]['GridConsumption'] = 0; }
        	if ( ! ( 'GridReturn' in flotDataStructure[ value[0] ] ) ) { flotDataStructure[ value[0] ]['GridReturn'] = 0; }
        	flotDataStructure[ value[0] ]['SolarProduction'] = value[1];
        });
        
        var newYMin = 0;
        var newYMax = 0;

        obj.dsSolarProduction = [];    //         Total Solar power generated
        obj.dsTotalConsumption = [];   //         Total consumed energy
        obj.dsGridReturn = [];         //         Solar energy returned to the grid
        obj.dsGridConsumption = [];    //         Energy consumed from the grid
        obj.dsReturnProduction = [];   // grey    Solar power generated and returned to the grid
        obj.dsUsedProduction = [];     // green   Solar power generated and used
        obj.dsNetConsumed = [];        // orange  Net energy consumed, this is the size of the bill. This is what we pay. If we are a producer, this is 0.
        obj.dsNetReturn = [];          // blue    If we are a producer this day, this is the amount net produced. This is the money we earned. Otherwise 0. For the graph this is NEGATIVE
        $.each( Object.keys(flotDataStructure), function( index, ts ) {

            //  The total produced solar energy amount consumed from the grid ( SolarProduction ) not shown
            obj.dsSolarProduction.push( [ ts, ( Math.round( flotDataStructure[ ts ]['SolarProduction'] * 1000 ) / 1000 ) ] );
            //  The total consumed energy, combined net grid consumption and used solar energy ( SolarProduction ) not shown
            obj.dsTotalConsumption.push( [ ts, ( Math.round( ( ( flotDataStructure[ ts ]['GridConsumption'] - flotDataStructure[ ts ]['GridReturn'] ) + ( flotDataStructure[ ts ]['SolarProduction'] - flotDataStructure[ ts ]['GridReturn'] ) ) * 1000 ) / 1000 ) ] );
            //  The total consumed energy, combined net grid consumption and used solar energy ( SolarProduction ) not shown
            obj.dsGridReturn.push( [ ts, ( Math.round( flotDataStructure[ ts ]['GridReturn'] * 1000 ) / 1000 ) ] );
            //  The energy consumed from the grid ( GridConsumption ) not shown
            obj.dsGridConsumption.push( [ ts, ( Math.round( flotDataStructure[ ts ]['GridConsumption'] * 1000 ) / 1000 ) ] );
        	// Determine net procucer of net consumer        	
    	   	if ( flotDataStructure[ ts ]['GridConsumption'] > flotDataStructure[ ts ]['GridReturn'] ) {
        		// Net Consumer
                //  we show the net amount consumed from the grid ( GridConsumption - GridReturn ) in orange
                //  on top we show the solar power generated and used ( SolarProduction - GridReturn ) in green
                //  on top we show the solar power generated and returned ( GridReturn ) in gray
                //  net return is 0, we are a net consumer
    	        obj.dsReturnProduction.push( [ ts, ( Math.round( flotDataStructure[ ts ]['GridReturn'] * 1000 ) / 1000 ) ] );
		        obj.dsUsedProduction.push( [ ts, ( Math.round( ( flotDataStructure[ ts ]['SolarProduction'] - flotDataStructure[ ts ]['GridReturn'] ) * 1000 ) / 1000 ) ] );
		        obj.dsNetConsumed.push( [ ts, ( Math.round( ( flotDataStructure[ ts ]['GridConsumption'] - flotDataStructure[ ts ]['GridReturn'] ) * 1000 ) / 1000 ) ] );
		        obj.dsNetReturn.push( [ ts, 0 ] );    // We are a net consumer, so no net production
				// Calculate new Y-axis
		        newYMax = Math.max( newYMax, Math.ceil( ( flotDataStructure[ ts ]['GridConsumption'] - flotDataStructure[ ts ]['GridReturn'] ) + flotDataStructure[ ts ]['SolarProduction'] ) );
            } else {
                // Net Producer
                //  we show the net amount returned to the grid ( GridReturn - GridConsumption ) in blue, below zero (= negative value)
                //  on top we show the solar power generated and used ( SolarProduction - ( GridReturn - GridConsumption ) ) in green
                //  thats all.
                obj.dsReturnProduction.push( [ ts, flotDataStructure[ ts ]['GridReturn'] ] );
                obj.dsUsedProduction.push( [ ts, ( Math.round( ( flotDataStructure[ ts ]['SolarProduction'] - ( flotDataStructure[ ts ]['GridReturn'] - flotDataStructure[ ts ]['GridConsumption'] ) ) * 1000 ) / 1000 ) ] );
                obj.dsNetConsumed.push( [ ts, 0 ] );    // We are a net producer, so no net consumption
                obj.dsNetReturn.push( [ ts, ( ( Math.round( ( flotDataStructure[ ts ]['GridReturn'] - flotDataStructure[ ts ]['GridConsumption'] ) * 1000 ) / 1000 ) * -1 ) ] );
				// Calculate new Y-axis
				newYMin = Math.min( newYMin, ( Math.ceil( flotDataStructure[ ts ]['GridReturn'] - flotDataStructure[ ts ]['GridConsumption'] ) * -1 ) );
        	}
        });

		// 1522965600000 is 6 april
        flotDataset.push( { label: 'Netto teruglevering', data: obj.dsNetReturn, color: "#3bafda" });                  // blue     #505a66 
        flotDataset.push( { label: 'Netto gridafname', data: obj.dsNetConsumed, color: "#ffbd4a" });                   // orange   #36404a
        flotDataset.push( { label: 'Verbruikte Zonneenergie', data: obj.dsUsedProduction, color: "#5fbeaa" });         // green
		flotDataset.push( { label: 'Teruggeleverde Zonneenergie', data: obj.dsReturnProduction, color: "#868e96" });   // gray    
     
        obj.flotGraph.setData( flotDataset );
 
        var opts = obj.flotGraph.getOptions();
		opts.yaxes[0].min = newYMin;
		opts.yaxes[0].max = newYMax;

        $('#stecapg_' + obj.uniqueId + '_waiting').toggleClass( 'invisible', true );
        ...
        // Element dows not exist, draw it
        console.log( timestamp() + " SplashTotalEnergyConsumptionAndProductionGraph.draw() - Drawing new element");

        var elStr = `<div id="stecapg_TOKEN_ID" class="TOKEN_WIDTHCLASS">
            <div class="portlet"><!-- /primary heading -->
                <div class="portlet-heading">
                    <h3 class="portlet-title text-dark">TOKEN_NAME</h3>
                    <div class="clearfix"></div>
                    <div class="btn-group" style="position: absolute; top: 20px; right: 30px;">
                        <button type="button" id="stecapg_TOKEN_ID_year" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;" onclick="flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].min = (new Date((new Date().getFullYear() -1), new Date().getMonth(), new Date().getDate(), new Date().getHours(), new Date().getMinutes())).getTime(); flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].tickSize = [ 1, 'month' ]; flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].timeformat = '%b %Y'; flotGraphs[ 'stecapg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'stecapg_TOKEN_ID' ].draw();"> Jaar </button>
                        <button type="button" id="stecapg_TOKEN_ID_today" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;" onclick="flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].min = (new Date(new Date().getFullYear(), (new Date().getMonth() -1), new Date().getDate(), new Date().getHours(), new Date().getMinutes())).getTime(); flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].tickSize = [ 1, 'day' ]; flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].timeformat = '%d %b'; flotGraphs[ 'stecapg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'stecapg_TOKEN_ID' ].draw();"> Maand </button>
                        <button type="button" id="stecapg_TOKEN_ID_week" class="btn btn-outline-light waves-effect waves-light" style="width: 70px;" onclick="flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].min = (new Date(new Date().getFullYear(), new Date().getMonth(), (new Date().getDate() - 7), 0, 0)).getTime(); flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].tickSize = [ 1, 'day' ]; flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().xaxes[0].timeformat = '%a %d %b'; flotGraphs[ 'stecapg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'stecapg_TOKEN_ID' ].draw();"> Week </button>
                   </div>
                    <div class="btn-group" style="position: absolute; top: 55px; left: 67px;">
                        <button type="button" id="stecapg_TOKEN_ID_yaxeszoomout" class="btn btn-outline-secondary btn-sm waves-effect waves-light" style="width: 38px;" onclick="flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().yaxes[0].max = flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().yaxes[0].max / 2; flotGraphs[ 'stecapg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'stecapg_TOKEN_ID' ].draw();"> <i class="fa fa-search-plus"></i> </button>
                        <button type="button" id="stecapg_TOKEN_ID_yaxeszoomin" class="btn btn-outline-secondary btn-sm waves-effect waves-light" style="width: 38px;" onclick="flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().yaxes[0].max = flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().yaxes[0].max * 2; flotGraphs[ 'stecapg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'stecapg_TOKEN_ID' ].draw();"> <i class="fa fa-search-minus"></i> </button>
                   </div>
                    <div class="btn-group" style="position: absolute; top: 55px; left: 150px;">
                        <button type="button" id="stecapg_TOKEN_ID_toggleLegenda" class="btn btn-outline-secondary btn-sm waves-effect waves-light" style="width: 38px;" onclick="flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().legend.show = (! ( flotGraphs[ 'stecapg_TOKEN_ID' ].getOptions().legend.show ) ); flotGraphs[ 'stecapg_TOKEN_ID' ].setupGrid(); flotGraphs[ 'stecapg_TOKEN_ID' ].draw();"> <i class="ion-map"></i> </button>
                   </div>
                </div>
                <div id="portlet TOKEN_ID" class="panel-collapse collapse show">
                    <div class="portlet-body">
                        <div id="stecapg_TOKEN_ID_flotgraph" style="height: 320px;" class="flot-chart"></div>
                        <div id="stecapg_TOKEN_ID_waiting" style="position: absolute; top: 50%; left: 50%; font-size: 30px;" class="flot-chart"> <i class="fa fa-refresh fa-spin fa-7x"></i> </div>
                    </div>
                </div>
            </div>
        </div>`;
        ...
        obj.flotGraph = $.plot($("#stecapg_"+obj.uniqueId+"_flotgraph"), flotDataset, {
            bars : {
                show : true,
                barWidth : (6 * 60 * 60 * 1000),	// On time x-axis it is in milli seconds
                fill : 1
            },
            legend: {
                position: 'ne',
...
//                    }
                    var solarProduction = 0;        //         Total Solar power generated
                    var totalConsumption = 0;       //         Total consumed energy
                    var gridReturn = 0;             //         Solar energy returned to the grid
                    var gridConsumption = 0;        //         Energy consumed from the grid

                    var netReturn = 0;              // If we are a producer this day, this is the amount net produced. This is the money we earned. Otherwise 0. For the graph this value is NEGATIVE
                    var netConsumed = 0;            // Net energy consumed, this is the size of the bill. This is what we pay. If we are a producer, this is 0.
                    var usedProduction = 0;         // Solar power generated and used
                    var dsReturnProduction = 0;     // Solar power generated and returned to the grid
                    $.each( Object.keys(obj.dsSolarProduction), function( index, key ) {
                        if ( xval == obj.dsSolarProduction[ key ][0] ) {
                            solarProduction = obj.dsSolarProduction[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsTotalConsumption), function( index, key ) {
                        if ( xval == obj.dsTotalConsumption[ key ][0] ) {
                            totalConsumption = obj.dsTotalConsumption[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsGridReturn), function( index, key ) {
                        if ( xval == obj.dsGridReturn[ key ][0] ) {
                            gridReturn = obj.dsGridReturn[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsGridConsumption), function( index, key ) {
                        if ( xval == obj.dsGridConsumption[ key ][0] ) {
                            gridConsumption = obj.dsGridConsumption[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsNetReturn), function( index, key ) {
                        if ( xval == obj.dsNetReturn[ key ][0] ) {
                            netReturn = obj.dsNetReturn[ key ][1] * -1;
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsNetConsumed), function( index, key ) {
                        if ( xval == obj.dsNetConsumed[ key ][0] ) {
                            netConsumed = obj.dsNetConsumed[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsUsedProduction), function( index, key ) {
                        if ( xval == obj.dsUsedProduction[ key ][0] ) {
                            usedProduction = obj.dsUsedProduction[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    $.each( Object.keys(obj.dsReturnProduction), function( index, key ) {
                        if ( xval == obj.dsReturnProduction[ key ][0] ) {
                            // Found it
                            returnProduction = obj.dsReturnProduction[ key ][1];
                            return false;   // 'return false' breaks the each, 'return true' goes to the next iteration
                        }
                    });
                    ...
                    var ttStr = '';
		    	   	...
		    	   	if ( netReturn > 0 ) {	// Negative (Return) is corrected * -1, so return is more than 0 in the positive
		        		// Net Producer
//	                   ttStr += 'NET PRODUCER netReturn: ' + netReturn + " grossReturn: " + grossReturn + " usedProduction: " + usedProduction + " netConsumed: " + netConsumed + "<br>";
	                   switch ( label ) {
	                        case 'Netto teruglevering':
                                ttStr += '<span style="color: #ef5350; font-weight: bold;">Opgewekte Zonneenergie</span><br>' + 
                                    solarProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * solarProduction) *100) /100).toFixed(2);
                                ttStr += '<br><span style="color: #ef5350; font-weight: bold;">Verbruikte Zonneenergie</span><br>' + 
                                    usedProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * usedProduction) *100) /100).toFixed(2);
                                ttStr += '<br><span style="color: #3bafda; font-weight: bold;">Netto teruglevering</span><br>' + 
                                    netReturn + 'kWh &euro; ' + (Math.round( (pricePer_kWh * netReturn * -1) *100) /100).toFixed(2);
	                            break;
	                        case 'Netto gridafname':       // 0 in a producer
	                            break;
	                        case 'Verbruikte Zonneenergie':
	                        case 'Teruggeleverde Zonneenergie':
	                            ttStr += '<span style="color: #ef5350; font-weight: bold;">Opgewekte zonneenergie</span><br>' + 
	                                solarProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * solarProduction) *100) /100).toFixed(2);
	                            ttStr += '<br><span style="color: #5fbeaa; font-weight: bold;">Verbruikte Zonneenergie</span><br>' + 
	                                usedProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * usedProduction) *100) /100).toFixed(2);
	                            ttStr += '<br><span style="color: #3bafda; font-weight: bold;">Teruggeleverde Zonneenergie</span><br>' + 
	                                netReturn + 'kWh &euro; ' + (Math.round( (pricePer_kWh * netReturn) *100) /100).toFixed(2);
	                            break;
	                        default:
	                    }
		        		...
		        		// Net Consumer
//	                   ttStr += 'NET CONSUMER gridReturn: ' + gridReturn + " gridConsumption: " + gridConsumption + " totalConsumption: " + totalConsumption + " usedProduction: " + usedProduction + " solarProduction: " + solarProduction + "<br>";
	                    switch ( label ) {
	                        case 'Netto teruglevering':    // 0 in a consumer
	                            break;
	                        case 'Netto gridafname':
	                            ttStr += '<span style="color: #5fbeaa; font-weight: bold;">Verbruikte Zonneenergie</span><br>' + 
	                                usedProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * usedProduction) *100) /100).toFixed(2);
	                            ttStr += '<br><span style="color: #ffbd4a; font-weight: bold;">Netto gridafname</span><br>' + 
	                                netConsumed + 'kWh &euro; ' + (Math.round( (pricePer_kWh * netConsumed) *100) /100).toFixed(2);
	                            ttStr += '<br><span style="color: #ef5350; font-weight: bold;">Totaal verbruik</span><br>' + 
	                                totalConsumption + 'kWh &euro; ' + (Math.round( (pricePer_kWh * totalConsumption) *100) /100).toFixed(2);
	                            break;
	                        case 'Verbruikte Zonneenergie':
	                        case 'Teruggeleverde Zonneenergie':
	                            ttStr += '<span style="color: #868e96; font-weight: bold;">Teruggeleverde Zonneenergie</span><br>' + 
	                                gridReturn + 'kWh &euro; ' + (Math.round( (pricePer_kWh * gridReturn) *100) /100).toFixed(2);
	                            ttStr += '<br><span style="color: #5fbeaa; font-weight: bold;">Verbruikte Zonneenergie</span><br>' + 
	                                usedProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * usedProduction) *100) /100).toFixed(2);
	                            ttStr += '<br><span style="color: #ef5350; font-weight: bold;">Totale zonneenergie</span><br>' + 
	                                solarProduction + 'kWh &euro; ' + (Math.round( (pricePer_kWh * solarProduction) *100) /100).toFixed(2);
	                            break;
	                        default:
	                    }
                    ...
                    ttStr += '<br>' + 
                        '<span style="color: #98a6ad !important"><i class="fa fa-calendar"></i> ' + d.getDate() + " " + monthToStr( nl_NL, d.getMonth() ) + " " + d.getFullYear() + '</span>';
...
//                twelveHourClock: false,
        ...
        flotGraphs[ 'stecapg_' + obj.uniqueId ] = obj.flotGraph;

        $('#stecapg_'+obj.uniqueId+'_flotgraph').bind("plotpan", function (event, plot) {
        });

        $('#stecapg_'+obj.uniqueId+'_flotgraph').bind("plotzoom", function (event, plot) {
            var axes = plot.getAxes();
            if ( ( axes.xaxis.max - axes.xaxis.min ) > (1.5 * 24 * 60 * 60 * 1000) ) {
                // switch to day xaxis
                axes.xaxis.options.tickSize = [1, "day"];
		...
		var hsgdbduHandler = new HSGraphDbDataUpdateHandler();	
		hsgdbduHandler.sourceType = HSGraphDbDataUpdateHandler.SOURCE_TYPE_ENERGY;	// is default, but to be sure 
        CentralSplashUpdater.register( obj.getGridConsumption().getUid(), hsgdbduHandler, function() { obj.draw() } );
        CentralSplashUpdater.register( obj.getGridReturn().getUid(), hsgdbduHandler, function() { obj.draw() } );
        CentralSplashUpdater.register( obj.getSolarProduction().getUid(), hsgdbduHandler, function() { obj.draw() } );
    }
}
...
SplashHarmonyDevice.prototype.draw = function( ) {
	...
	if ( $('div#slhd_' + ref).length ) {
		...
		// Harmony - Activity (1: PowerOff, 2: TV kijken, 3: Radio, 4: iTV met Marantz, 5: Gramofon, 6: Netflix, 7: Netflix met Marantz, 8: Smart-TV Marantz, 9: Smart-TV)
		...
		switch ( hsDev.getValue() ) {
			...
			case 34821455:		// Smart-TV
				...
				$('h3#slhd_'+ref+'_activity_text').html('Smart-TV');
				break;
			case 34821369:		// Smart-TV Marantz
				$('div#slhd_'+ref+'_tvpresets').slideUp();
				$('div#slhd_'+ref+'_radiopresets').slideUp();
				$('div#slhd_'+ref+'_colorbuttons').slideUp();
				$('div#slhd_'+ref+'_videocontrols').slideDown();
				...
				$('div#slhd_'+ref+'_mutemenucontrols').slideUp();
				$('div#slhd_'+ref+'_mutecontrol').slideDown();
				$('h3#slhd_'+ref+'_activity_text').html('Smart-TV Marantz');
				break;
			case 34801846:		// Netflix met Marantz
				$('div#slhd_'+ref+'_tvpresets').slideUp();
				$('div#slhd_'+ref+'_radiopresets').slideUp();
				$('div#slhd_'+ref+'_colorbuttons').slideUp();
				$('div#slhd_'+ref+'_videocontrols').slideDown();
				...
				$('div#slhd_'+ref+'_mutemenucontrols').slideUp();
				$('div#slhd_'+ref+'_mutecontrol').slideDown();
				$('h3#slhd_'+ref+'_activity_text').html('Netflix Marantz');
				break;
			case 34640434:		// Netflix
				$('div#slhd_'+ref+'_tvpresets').slideUp();
				$('div#slhd_'+ref+'_radiopresets').slideUp();
				$('div#slhd_'+ref+'_colorbuttons').slideUp();
				$('div#slhd_'+ref+'_videocontrols').slideDown();
				...
				$('div#slhd_'+ref+'_mutemenucontrols').slideUp();
				$('div#slhd_'+ref+'_mutecontrol').slideDown();
				$('h3#slhd_'+ref+'_activity_text').html('Netflix');
				break;
			case 11358301:		// Gramofon
				$('div#slhd_'+ref+'_tvpresets').slideUp();
				$('div#slhd_'+ref+'_radiopresets').slideUp();
				$('div#slhd_'+ref+'_colorbuttons').slideUp();
			...
			<div class="card-box lh-card-box">
				...
				<div>
					<div class="slhd_activity_wrapper">
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_tv" class="slhd_activity btn btn-outline-warning w-lg waves-effect waves-light font-13 text-center" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 10894043 );"> <i class="fa fa-tv"> </i><br>TV </button>
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_radio" class="slhd_activity btn btn-outline-info w-lg waves-effect waves-light font-13 text-center" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 10894044 );"> <i class="fa fa-signal"> </i><br>Radio </button>
                        <button type="button" id="slhd_TOKEN_REF_ACTIVITY_spotify" class="slhd_activity btn btn-outline-spotify w-lg waves-effect waves-light font-13 text-center" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 11358301 );"> <i class="fa fa-spotify"> </i><br>Gramofon </button>
				...
				<div id="slhd_TOKEN_REF_ACTIVITY_tvpresets">
					<div class="slhd_preset_wrapper">
						...
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_tvpreset_9" class="slhd_tvpreset btn btn-outline-secondary waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, [ 3, 11 ] );"> <img src="assets/images/logo/sbs9-logo.png" style="height: 30px;"> </button>
				...
				<div id="slhd_TOKEN_REF_ACTIVITY_colorbuttons">
					<div class="slhd_colorbutton_wrapper">
						<button type="button" class="slhd_color btn btn-danger waves-effect waves-light m-l-5 m-r-5" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, 24 );"> </button>
...
SplashHarmonyDevice.prototype.volumeUp = function( ) {
	var hsDev = this.getHSDev();
	if ( [ 10894044, 11358301 ].includes(hsDev.getValue()) ) {				// Radio, Gramofon
		SplashHSDeviceUpdate( this.getReceiverRef(), 18 );		// Volume Up on Receiver [799]
	}
	if ( [ 10894043 ].includes(hsDev.getValue()) ) {					// TV Kijken
		SplashHSDeviceUpdate( this.getTVRef(), 14 );			// Volume Up on TV [801]
	}
}
...
SplashHarmonyDevice.prototype.volumeDown = function( ) {
	...
	if ( [ 10894043 ].includes(hsDev.getValue()) ) {					// TV Kijken
		SplashHSDeviceUpdate( this.getTVRef(), 13 );			// Volume Down on TV [801]
	}
}
...
SplashHarmonyDevice.prototype.mute = function( ) {
	...
	if ( [ 10894043 ].includes(hsDev.getValue()) ) {					// TV Kijken
		SplashHSDeviceUpdate( this.getTVRef(), 12 );			// Mute on TV [801]
	}
}
...
SplashLivingroomDevice.prototype.draw = function( ) {
	...
	if ( $('div#slrd').length ) {
		...
		var hsd376 = HSDeviceFactory.create( 376);			// Kleurenlamp
		...
		value = Math.max( value, ( hsd376.getValue() > 0 ? 10 : 0 ) );
...
//		$( this.getBindingElement() ).append('<div class="' + this.getWidthClass() + '" id="slrd"><div class="card-box"><form class="form-horizontal"><div class="form-group"><label for="slrd_slider" class="control-label"><b>Woonkamer</b> <span class="font-normal text-muted clearfix">dimmer</span></label><div class="m-b-20"><input type="text" id="slrd_slider"></div><div><div class="slrdb_activity_wrapper"><div class="btn-group m-b-10"><button type="button" id="slrdb_on" class="slrdb_on btn btn-light waves-effect"> <i class="fa fa-toggle-on m-r-5"></i> <span>Aan</span></button><button type="button" id="slrdb_off" class="slrdb_off btn btn-outline-light waves-effect waves-dark"> <i class="fa fa-toggle-off m-r-5"></i> <span>Uit</span></button></div>&nbsp;<div class="btn-group m-b-10"><button type="button" id="slrdb_plus" class="slrdb_plus btn btn-light waves-effect waves-light"> <i class="fa fa-chevron-up m-r-5"></i> </button><button type="button" id="slrdb_min" class="slrdb_min btn btn-outline-light waves-effect waves-light"> <i class="fa fa-chevron-down m-r-5"> </i> </button></div>&nbsp;<div class="btn-group m-b-10"><button type="button" id="slrdb_movie" class="slrdb_movie btn btn-outline-info waves-effect waves-light"><i class="fa fa-television m-r-5"></i> <span>Film</span></button><button type="button" id="slrdb_entertain" class="slrdb_entertain btn btn-outline-success waves-effect waves-light"><i class="fa fa-comments m-r-5"></i> <span>Visite</span></button><button type="button" id="slrdb_kook" class="slrdb_kook btn btn-outline-warning waves-effect waves-light"><i class="fa fa-search m-r-5"></i> <span>Koken</span></button><button type="button" id="slrdb_bright" class="slrdb_bright btn btn-outline-danger waves-effect waves-light"><i class="fa fa-sun-o m-r-5"></i> <span>Bright</span></button></div></div></div> </div></form></div></div>');
		...
		CentralSplashUpdater.register( 376, HSUpdateHandler, function() { obj.draw() } );	// Woonkamer Kleurenlamp
...
function setHSLivingroomDevices( value, notify = true, specificValues = null ) {
	var devArray = [ 298, 376, 422, 441, 508, 738, 814 ];
...
SplashTempDevice.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashTempDevice.prototype.getWidthClass = function( ) {
    return this.widthClass;
}
...
SplashTempDevice.prototype.draw = function( ) {
	...
	if ( $('div#std_' + ref).length ) {
        ...
        $('p#std_' + ref + '_lastUpdate').html( hsDev.getLastChangeWithTimeHtml() );
        ...
        var elStr = `<div class="TOKEN_WIDTH_CLASS col-md-6" id="std_TOKEN_ID">
            <div class="widget-bg-color-icon card-box">
                <div id="std_TOKEN_ID_bg-icon" class="bg-icon bg-icon-warning pull-left">
                    <i id="std_TOKEN_ID_thermometer" class="fa fa-thermometer-empty text-primary"></i>
                </div>
                <div class="text-right">
                    <h3 id="std_TOKEN_ID_status" class="text-primary m-t-10">--%</h3>
                    <h7 id="std_TOKEN_ID_name" class="text-dark m-t-10">--</h7>
                    <p id="std_TOKEN_ID_location" class="text-muted mb-0 blockquote-reverse">--</p>
                    <p id="std_TOKEN_ID_lastUpdate" class="text-muted mb-0 blockquote-reverse"></p>
                    <div class="clearfix">
                </div>
            </div>
        </div>`;
        ...
        $('p#std_' + ref + '_lastUpdate').slideUp();  // default slideUp
		$('div#std_'+ref).click( function(e) {
            $('p#std_' + ref + '_location').slideToggle();  // slideUp/ slideDown
            $('p#std_' + ref + '_lastUpdate').slideToggle();  // slideUp/ slideDown
		});	
...
SplashHumidDevice.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashHumidDevice.prototype.getWidthClass = function( ) {
    return this.widthClass;
}
...
SplashHumidDevice.prototype.draw = function( ) {
	...
	if ( $('div#shd_' + ref).length ) {
        ...
        $('p#shd_' + ref + '_lastUpdate').html( hsDev.getLastChangeWithTimeHtml() );

	} else {
		// Element dows not exist, draw it
		console.log( timestamp() + " SplashHumidDevice.draw() - Drawing new element");

        var elStr = `<div class="TOKEN_WIDTH_CLASS col-md-6" id="shd_TOKEN_ID">
            <div class="widget-bg-color-icon card-box">
                <div class="bg-icon bg-icon-primary pull-left">
                    <i class="wi wi-humidity text-primary"></i>
                </div>
                <div class="text-right">
                    <h3 id="shd_TOKEN_ID_status" class="text-primary m-t-10">--%</h3>
                    <h7 id="shd_TOKEN_ID_name" class="text-dark m-t-10">--</h7>
                    <p id="shd_TOKEN_ID_location" class="text-muted mb-0 blockquote-reverse">--</p>
                    <p id="shd_TOKEN_ID_lastUpdate" class="text-muted mb-0 blockquote-reverse"></p>
                    <div class="clearfix">
                </div>
            </div>
        </div>`;
        ...
        $('p#shd_' + ref + '_lastUpdate').slideUp();  // default slideup
		$('div#shd_'+ref).click( function(e) {
            $('p#shd_' + ref + '_location').slideToggle();  // slideUp/ slideDown
            $('p#shd_' + ref + '_lastUpdate').slideToggle();  // slideUp/ slideDown
		});	
...
// ----------------------- Door/Window Device Object ------------------------------------------
// Represents a Splash Door/Window device

function SplashDoorWindowDevice ( ref ) {
    this.hsdev = HSDeviceFactory.create( ref );
    // Element tot attach it to
    this.bindingElement = null;
    this.widthClass = 'col-lg-3';
...
SplashDoorWindowDevice.prototype.getHSDev = function( ) {
    return this.hsdev;
}
SplashDoorWindowDevice.prototype.setBindingElement = function( bindingElement ) {
    this.bindingElement = bindingElement;
}
SplashDoorWindowDevice.prototype.getBindingElement = function( ) {
    return this.bindingElement;
}
SplashDoorWindowDevice.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashDoorWindowDevice.prototype.getWidthClass = function( ) {
    return this.widthClass;
}

SplashDoorWindowDevice.prototype.draw = function( ) {
    console.log( timestamp() + " SplashDoorWindowDevice.draw()");
    var obj = this;
    var hsDev = this.getHSDev();
    var ref = hsDev.getRef();
    // Does the element exist? No: draw, Yes: update
    if ( $('div#sdwd_' + ref).length ) {
        console.log( timestamp() + " SplashDoorWindowDevice.draw() - Update the element");
        var el = $('div#sdwd_'+ref+' div div#sdwd_'+ref+'_icon');
        switch ( hsDev.getValue() ) {
            case 22: //DOORWINDOW_OPEN:       // 22
            case 23: //DOORWINDOW_CLOSED:     // 23
                el.toggleClass('bg-icon-success', ( hsDev.getValue() == 23 ));
                el.toggleClass('bg-icon-danger', ( hsDev.getValue() == 22 ));
                el = el.find('i');
                el.toggleClass('fa-question-circle', false);
                el.toggleClass('fa-check-square-o', ( hsDev.getValue() == 23 ));
                el.toggleClass('text-success', ( hsDev.getValue() == 23 ));
                el.toggleClass('fa-exclamation-triangle', ( hsDev.getValue() == 22 ));
                el.toggleClass('text-pink', ( hsDev.getValue() == 22 ));
                $('h3#sdwd_' + ref + '_status').text( ( hsDev.getValue() == 23 ? 'Gesloten' : 'Open' ) );
                break;
            default:
                el.toggleClass('bg-icon-success', false);
                el.toggleClass('bg-icon-danger', true);
                el = el.find('i');
                el.toggleClass('fa-question-circle', true);
                el.toggleClass('fa-check-square-o', false);
                el.toggleClass('text-success', false);
                el.toggleClass('fa-exclamation-triangle', true);
                el.toggleClass('text-pink', true);
                $('h3#sdwd_' + ref + '_status').text( 'Unknown' );
                break;
        }

        $('h7#sdwd_' + ref + '_name').text( hsDev.getName() );
        $('p#sdwd_' + ref + '_lastUpdate').html( hsDev.getLastChangeWithTimeHtml() );
        $('p#sdwd_' + ref + '_location').text( hsDev.getLocation() );

    } else {
        // Element dows not exist, draw it
        console.log( timestamp() + " SplashDoorWindowDevice.draw() - Drawing new element");

        var elStr = `<div class="TOKEN_WIDTH_CLASS" id="sdwd_TOKEN_ID">
            <div class="widget-bg-color-icon card-box">
                <div id="sdwd_TOKEN_ID_icon" class="bg-icon bg-icon-danger pull-left">
                    <i class="fa fa-question-circle"></i>
                </div>
                <div class="text-right">
                    <h3 id="sdwd_TOKEN_ID_status" class="text-success m-t-10">--</h3>
                    <h7 id="sdwd_TOKEN_ID_name" class="text-dark m-t-10">--</h7>
                    <p id="sdwd_TOKEN_ID_location" class="text-muted mb-0 blockquote-reverse">--</p>
                    <p id="sdwd_TOKEN_ID_lastUpdate" class="text-muted mb-0 blockquote-reverse" style="margin-top: 30px;">--</p>
                    <div class="clearfix">
                </div>
            </div>
        </div>`;

        elStr = elStr.replace( /TOKEN_WIDTH_CLASS/g, obj.getWidthClass() );    // 
        elStr = elStr.replace( /TOKEN_ID/g, ref );

        $( this.getBindingElement() ).append( elStr );

        // Onclick toggle the uptime
        $('p#sdwd_' + ref + '_lastUpdate').slideUp();    // default slideup
        $('p#sdwd_' + ref + '_location').slideUp();  // default slideup
        $('div#sdwd_'+ref).click( function(e) {
            $('p#sdwd_' + ref + '_lastUpdate').slideToggle();    // slideUp/ slideDown
            $('p#sdwd_' + ref + '_location').slideToggle();  // slideUp/ slideDown
            $('p#sdwd_' + ref + '_location2').slideToggle(); // slideUp/ slideDown
        }); 
...
SplashTwoButtonFanDevice.prototype.setWidthClass = function( widthClass ) {
    this.widthClass = widthClass;
}
SplashTwoButtonFanDevice.prototype.getWidthClass = function( ) {
    return this.widthClass;
}
...
function SplashLightDevice ( ref ) {
	...
	// Default width class. Works with col-lg-4, col-lg-6 and col-12
    this.widthClass = 'col-lg-3';	// col-lg-3 col-md-6
    this.iconOn = 'ion-ios7-lightbulb';
    this.iconOff = 'ion-ios7-lightbulb-outline';
}
...
SplashLightDevice.prototype.setIconOn = function( iconOn ) {
    this.iconOn = iconOn;
}
SplashLightDevice.prototype.getIconOn = function( ) {
    return this.iconOn;
}
SplashLightDevice.prototype.setIconOff = function( iconOff ) {
    this.iconOff = iconOff;
}
SplashLightDevice.prototype.getIconOff = function( ) {
    return this.iconOff;
}
...
SplashLightDevice.prototype.drawElement = function( ) {
	...
	if ( $('div#sld_' + ref).length ) {
		...
		if ( hsDev.canDim() && $('div#sld_' + ref).find('div.widget-bg-color-icon').length ) {
        	...
        	$('#sld_'+ref+'_bulbicon').toggleClass( this.getIconOff(), hsDev.isOff() );
        	$('#sld_'+ref+'_bulbicon').toggleClass( this.getIconOn(), ( !hsDev.isOff() ) );
        	// Check the switch
		...
		if ( hsDev.canDim() ) {
	        ...
	        var elStr = `<div class="TOKEN_WIDTH_CLASS" id="sld_TOKEN_REF">
	        	<div class="widget-bg-color-icon card-box">
	        		<div id="sld_TOKEN_REF_circle" class="bg-icon bg-icon-inverse pull-left">
	        			<i id="sld_TOKEN_REF_bulbicon" class="TOKEN_ICON text-purple"></i>
	        		</div>
	        		<div id="sld_TOKEN_REF_textbox" class="wid-icon-info text-right">
	        			<p id="sld_TOKEN_REF_name" class="text-muted m-b-5 font-13 text-uppercase">---</p>
	        			<p id="sld_TOKEN_REF_func" class="text-muted m-b-5 font-15">---</p>
			...
			elStr = elStr.replace( /TOKEN_REF/g, ref );
            elStr = elStr.replace( /TOKEN_WIDTH_CLASS/g, this.getWidthClass() );
            elStr = elStr.replace( /TOKEN_ICON/g, this.getIconOff() );
...
SplashLightDevice.prototype.drawOnOffButtons = function( ) {
	...
	if ( ! $('div#sld_buttonblock_' + ref).length ) {
		...
		$('input#sld_'+ref+'_onoff').on('click', function() {			
        	...
        	$('#sld_'+ref+'_bulbicon').toggleClass( obj.getIconOff(), ( !$(this).is(":checked") ) );
        	$('#sld_'+ref+'_bulbicon').toggleClass( obj.getIconOn(), $(this).is(":checked") );
