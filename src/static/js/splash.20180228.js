...
var CentralEHUpdater = {
    ...
    update: function ( locationId ) {
		...
		.done(function( data ) {
			var ref = getKeyInObject( data, 'ref' );
			console.log( timestamp() + " CentralEHUpdater.update() - Successful response for " + locationId );
			console.log( data );
...
SplashLightDevice.prototype.drawSlider = function( ) {
	...
	if ( $('div#sld_sliderblock_' + ref).length ) {
        ...
        $( 'div#sld_'+ref+'_textbox' ).append('<div id="sld_sliderblock_' + ref + '"><input type="text" id="sld_slider_' + ref + '"></div>');
...
SplashLightDevice.prototype.drawOnOffButtons = function( ) {
	...
	if ( ! $('div#sld_buttonblock_' + ref).length ) {
		...
		$( 'div#sld_'+ref+'_textbox' ).append('<div id="sld_buttonblock_' + ref + '"><div class="switch"><input id="sld_'+ref+'_onoff" type="checkbox" name="toggle"'+(hsDev.getValue()!=0?' checked':'')+'><label for="toggle"><i></i></label><span></span> </div>');
