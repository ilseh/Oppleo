...
var hsDevices = [[ 298, 'Woonkamer',	'SplashLightDevice',	null ],
 				 ...
 				 [ 348, 'Gardarobe',	'',						null ], // Gardarobe Eye Motion
 				 [ 349, 'Gardarobe',	'SplashTempDevice',		null ], // Gardarobe Eye Temperature
 				 [ 350, 'Gardarobe',	'',						null ], // Gardarobe Eye Luminance (LUX)
...
var CentralBoseUpdater = {
    ...
    update: function ( ip ) {
		...
		.always(function() {
			...
			setTimeout( function() { CentralBoseUpdater.update( ip ) }, CentralBoseUpdater.getInterval() );
		});
    }
}
...
SplashSoundTouch.prototype.draw = function( ) {
	...
	if ( $('div#bstd_' + ipId).length ) {
		...
		$('#bstd_'+ipId+'_nowPlaying_art').html( soundTouch.getArt() );
		...
		var elStr = `<div class="col-lg-6" id="bstd_TOKEN_IPNODOTS">
			<div class="card-box bstd-card-box">
				...
				<div id="bstd_TOKEN_IPNODOTS_nowPlaying_internetradio">
					<div class="nrr_schedule_wrapper" style="width: 100%; padding-top: 10px; padding-bottom: 20px; text-align: center;">
						<div style="width: 100%; padding-top: 20px;">
							<img id="bstd_TOKEN_IPNODOTS_nowPlaying_art" style="max-width: 60px; max-height: 60px;" src="http://item.radio456.com/007452/logo/logo-41.jpg">
				...
				<div id="bstd_TOKEN_IPNODOTS_nowPlaying_spotify">
					<div class="nrr_schedule_wrapper" style="width: 100%; padding-top: 10px; padding-bottom: 20px; text-align: center;">
						<div style="width: 100%; padding-top: 20px;">
							<img id="bstd_TOKEN_IPNODOTS_nowPlaying_art" style="max-width: 60px; max-height: 60px;" src="http://i.scdn.co/image/31183bdfa154ad13c8b7328fd9ece88a00449f6c">
							<h5 id="bstd_TOKEN_IPNODOTS_nowPlaying_track" class="m-t-2 m-b-5 p-b-2" style="color: #191414; padding-top: 20px;"></h5>
...
SplashHarmonyDevice.prototype.draw = function( ) {
	...
	if ( $('div#slhd_' + ref).length ) {
		...
		$('button#slhd_'+ref+'_spotify').removeClass('btn-success');	$('button#slhd_'+ref+'_spotify').addClass('btn-outline-success');
		...
		switch ( hsDev.getValue() ) {
			case 7:		// Gramofon
				...
				$('button#slhd_'+ref+'_spotify').addClass('btn-success');
				$('button#slhd_'+ref+'_spotify').removeClass('btn-outline-success');
			...
			<div class="card-box lh-card-box">
				...
				<div>
					<div class="slhd_activity_wrapper">
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_tv" class="slhd_activity btn btn-outline-warning w-lg waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 2 );"> <i class="fa fa-tv fa-2x"> </i> </button>
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_spotify" class="slhd_activity btn btn-outline-success w-lg waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 7 );"> <i class="fa fa-spotify fa-2x"> </i> </button>
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_radio" class="slhd_activity btn btn-outline-info w-lg waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 3 );"> <i class="fa fa-signal fa-2x"> </i> </button>
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_off" class="slhd_activity btn btn-outline-light w-lg waves-effect waves-dark" onclick="SplashHSDeviceUpdate( TOKEN_REF_ACTIVITY, 1 );"> <i class="fa fa-power-off fa-2x"> </i> </button>
					</div>
				</div>
						...
						<div class="btn-group-vertical">
							<div class="btn-group">
								<div class="btn-group-vertical m-10" id="slhd_TOKEN_REF_ACTIVITY_volumecontrols">
									<button type="button" class="btn btn-outline-secondary btn-sm waves-effect waves-light" onclick="slhdTOKEN_REF_ACTIVITY.volumeUp();"> <i class="fa fa-volume-up fa-lg ml-4 mr-4 mt-1 mb-1"></i> </button>
									<button type="button" class="btn btn-outline-secondary btn-sm waves-effect waves-light" onclick="slhdTOKEN_REF_ACTIVITY.volumeDown();"> <i class="fa fa-volume-down fa-lg ml-4 mr-4 mt-1 mb-1"> </i> </button>
								</div>
								<div style="width: 10px;">
								</div>
								<div class="btn-group-vertical m-10" id="slhd_TOKEN_REF_ACTIVITY_volumecontrols">
									<button type="button" class="btn btn-outline-secondary btn-sm waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, 14 );"> <i class="fa fa-chevron-up fa-lg ml-4 mr-4 mt-1 mb-1"></i> </button>
									<button type="button" class="btn btn-outline-secondary btn-sm waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, 13 );"> <i class="fa fa-chevron-down fa-lg ml-4 mr-4 mt-1 mb-1"> </i> </button>
								</div>
							</div>
							<div class="btn-group m-b-10 m-t-10 m-l-10 p-l-10" id="slhd_TOKEN_REF_ACTIVITY_exitguidecontrols" style="margin-bottom: 0px;">
								<button type="button" class="btn btn-outline-secondary waves-effect waves-light pl-1 pr-1" style="margin-top: 5px; height: 35px;" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, 34 );"> <h5>Exit</h5> </button>
								<button type="button" class="btn btn-outline-secondary waves-effect waves-light pl-2 pr-2" style="margin-top: 5px; height: 35px;" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, 32 );"> <h5>Guide</h5> </button>
								<button type="button" class="btn btn-outline-secondary waves-effect waves-light pl-2 pr-4" style="margin-top: 5px; height: 35px;" onclick="slhdTOKEN_REF_ACTIVITY.mute();"> <h5><i class="fa fa-volume-off fa-lg mr-1"> </i> Mute</h5> </button>
							</div>
						</div>
					</div>
				</div>
				...
				<div id="slhd_TOKEN_REF_ACTIVITY_tvpresets">
					<div class="slhd_preset_wrapper">
						...
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_tvpreset_13" class="slhd_tvpreset btn btn-outline-secondary waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, [ 5, 7 ] );"> <img src="assets/images/logo/eurosport_1.png" style="padding-top: 13px; padding-bottom: 13px; width: 42px;"> </button>
						<button type="button" id="slhd_TOKEN_REF_ACTIVITY_tvpreset_14" class="slhd_tvpreset btn btn-outline-secondary waves-effect waves-light" onclick="SplashHSDeviceUpdate( TOKEN_REF_TVRECEIVER, [ 5, 8 ] );"> <img src="assets/images/logo/eurosport_2.png" style="padding-top: 13px; padding-bottom: 13px; width: 42px;"> </button>
