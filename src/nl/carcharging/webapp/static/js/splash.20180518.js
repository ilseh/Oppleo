...
//  js object
//  power
var hsDevices = [[ 267, 'Meterkast',	'SplashPowerDevice',	null ], // Meterkast Current total usage
                 ...
                 [ 272, 'Meterkast',    'SplashPowerDevice',    null ], // Elektra huidige teruglevering
                 [ 273, 'Meterkast',    '',                     null ], // Elektra teruglevering vandaag min
                 [ 274, 'Meterkast',    '',                     null ], // Elektra teruglevering vandaag max
                 ...
                 [ 378, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 2 ( 393, 378, 381, 384, 387, 390 )
                 [ 379, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 2 ( 394, 379, 382, 385, 388, 391 )
                 [ 381, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 3 ( 393, 378, 381, 384, 387, 390 )
                 [ 382, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 3 ( 394, 379, 382, 385, 388, 391 )
                 ...
                 [ 390, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 6 ( 393, 378, 381, 384, 387, 390 )
                 [ 391, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 6 ( 394, 379, 382, 385, 388, 391 )
                 [ 393, 'Woonkamer',    'SplashEnergyDevice',   null ], // Stekkerdoos kWh 1 ( 393, 378, 381, 384, 387, 390 )
                 [ 394, 'Woonkamer',    'SplashPowerDevice',    null ], // Stekkerdoos Power 1 ( 394, 379, 382, 385, 388, 391 )
                 ...
                 [ 596, 'Slaapkamer',   '',                     null ], // Wandlampen Watt
                 [ 597, 'Slaapkamer',   'SplashPowerDevice',    null ], // Wandlampen Power
                 ...
                 [ 867, 'Keuken',       'SplashEnergyDevice',   null ], // Koelkast kW Hours    
                 ...
                 [ 877, 'Berging',      'SplashEnergyDevice',   null ], // Koelkast kW Hours     
...
function HSGraphDbDataUpdateHandler( uniqueId = null ) {
    ...
    this.end = null;	// End is dwefault Now (= null)
}
...
Object.defineProperty(SplashEnergyGraph, "SOURCE_TYPE_EVENTS", { value: 1 });
Object.defineProperty(SplashEnergyGraph, "SOURCE_TYPE_ENERGY", { value: 2 });
...
//                    yaxes[ value.obj.getType() ].fontColor = '#98a6ad';     // Multiple datasets for one yaxis, use generic color
        ...
        var yaxes = [];
        $.each( obj.refList, function( index, value ) {
            flotDataset.push( { } );	// Just jam empty datasets
        ...
        obj.flotGraph = $.plot($("#seg_"+obj.uniqueId+"_flotgraph"), flotDataset, {
            ...
            tooltipOpts : {
                content: function(label, xval, yval, flotItem) {
                    ...
                    return '<span style="color: ' + flotItem.series.color + '; font-weight: bold;"> ' + label +'</span><br>' + 
...
//                twelveHourClock: false,
                mode: "time",
                min: (new Date(new Date().getFullYear(), new Date().getMonth(), (new Date().getDate() - 7), new Date().getHours(), new Date().getMinutes())).getTime(),
