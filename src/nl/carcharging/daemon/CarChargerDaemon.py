...
import nl.carcharging.webapp.WebApp
...
class CarChargerDaemon(Service):
    logger = None
    ...
    def __init__(self, energy_util: EnergyUtil, charger: Charger, ledlighter: LedLighter, buzzer: Buzzer):
        ...
        self.logger = logging.getLogger('nl.carcharging.daemon.CarChargerDaemon')
        self.logger.debug('Initializing WebApp')


    def run(self):
        global wsThread
        app = WebAppConfig.app
        appSocketIO = WebAppConfig.appSocketIO
