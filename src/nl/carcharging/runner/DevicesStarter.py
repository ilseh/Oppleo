...
from nl.carcharging.daemon.LedLightHandler import LedLightHandler, PROCESS_NAME as LedLight_PROCESS_NAME
from nl.carcharging.daemon.MeasureElectricityUsage import MeasureElectricityUsage, PROCESS_NAME as MeasureElectricity_PROCESS_NAME
